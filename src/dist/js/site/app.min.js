/*
Template Name: NtirApp
Author: Tjavan
Website: https://tjavan.com/
Contact: info@tjavan.com
File: Layout
*/
...
!function ($) {
    ...
    function ($) {
        ...
        ThemeCustomizer.prototype.initConfig = function () {
            ...
            config['topbar']['color'] = this.body.getAttribute('data-layout-color') ?? this.defaultConfig.layout.color;
            config['sidebar']['user'] = this.body.getAttribute('data-layout-color') ?? this.defaultConfig.layout.color;
        ...
        ThemeCustomizer.prototype.initSwitchListener = function () {
            ...
            document.querySelectorAll('.change-theme').forEach(function (element) {
                element.addEventListener('click', function (e) {
                    const themeColor = $(element).attr('data-theme');
                    let value = 'light';
                    if (themeColor == 'light') {
                        $(element).attr('data-theme', 'dark').html(`<i class="fe-sun noti-icon"></i>`);
                        value = 'dark';
                    } else {
                        $(element).attr('data-theme', 'light').html(`<i class="fe-moon noti-icon"></i>`);
                        value = 'light';
                    }
                    ...
                    self.changeLayoutColor(value);
                    self.changeLeftbarColor(value);
                    self.changeTopbarColor(value);
                })
            });
            ...
            document.querySelector('.button-menu-mobile')?.addEventListener('click', function () {
                ...
                console.log(self.config.leftbar.size);
                let data = {
                    action: 'sidebar-size',
                    size: self.config.leftbar.size,
                };
                $.ajax({
                    type: 'POST',
                    url: '/api/adminAjax',
...
function toastNotic(title, desc, icons = 'error') {
    let bgColors = 'ec223d';
...
window.addEventListener("load", function () {
    if ("serviceWorker" in navigator) {
        navigator.serviceWorker
            .register(window.location.origin+"/sw.js?v=1")
            // eslint-disable-next-line no-console
            .then(() =>console.log(window.location.origin))
            // eslint-disable-next-line no-console
...
/*$(document).on('click','.btnChangeLang',function (){
   $('#lang-modal-h').removeClass('d-none');
});*/

$(document).on('click', 'input[name="lang-radio"]', function () {
    let lang = $('input[name="lang-radio"]:checked').val();
    setCookieA('language', lang);
    setCookieA('language-flag', '1');

    const params = {
        action: 'update-user-lang',
        lang: lang,
    };
    $.ajax({
        url: '/api/ajax',
...
console.warn('' +
    ' ! \n ' +
    '!                    TTTTTTTTTTTTTTTTTTTTTTT  iiii                                     AAA\n ' +
    '!                    T:::::::::::::::::::::T i::::i                                   A:::A\n ' +
    '!                    T:::::::::::::::::::::T  iiii                                   A:::::A\n ' +
    '!                    T:::::TT:::::::TT:::::T                                        A:::::::A\n ' +
    '!  nnnn  nnnnnnnn    TTTTTT  T:::::T  TTTTTTiiiiiii rrrrr   rrrrrrrrr              A:::::::::A           ppppp   ppppppppp   ppppp   ppppppppp\n ' +
    '!  n:::nn::::::::nn          T:::::T        i:::::i r::::rrr:::::::::r            A:::::A:::::A          p::::ppp:::::::::p  p::::ppp:::::::::p\n ' +
    '!  n::::::::::::::nn         T:::::T         i::::i r:::::::::::::::::r          A:::::A A:::::A         p:::::::::::::::::p p:::::::::::::::::p\n ' +
    '!  nn:::::::::::::::n        T:::::T         i::::i rr::::::rrrrr::::::r        A:::::A   A:::::A        pp::::::ppppp::::::ppp::::::ppppp::::::p\n ' +
    '!    n:::::nnnn:::::n        T:::::T         i::::i  r:::::r     r:::::r       A:::::A     A:::::A        p:::::p     p:::::p p:::::p     p:::::p\n ' +
    '!    n::::n    n::::n        T:::::T         i::::i  r:::::r     rrrrrrr      A:::::AAAAAAAAA:::::A       p:::::p     p:::::p p:::::p     p:::::p\n ' +
    '!    n::::n    n::::n        T:::::T         i::::i  r:::::r                 A:::::::::::::::::::::A      p:::::p     p:::::p p:::::p     p:::::p\n ' +
    '!    n::::n    n::::n        T:::::T         i::::i  r:::::r                A:::::AAAAAAAAAAAAA:::::A     p:::::p    p::::::p p:::::p    p::::::p\n ' +
    '!    n::::n    n::::n      TT:::::::TT      i::::::i r:::::r               A:::::A             A:::::A    p:::::ppppp:::::::p p:::::ppppp:::::::p\n ' +
    '!    n::::n    n::::n      T:::::::::T      i::::::i r:::::r              A:::::A               A:::::A   p::::::::::::::::p  p::::::::::::::::p\n ' +
    '!    n::::n    n::::n      T:::::::::T      i::::::i r:::::r             A:::::A                 A:::::A  p::::::::::::::pp   p::::::::::::::pp\n ' +
    '!    nnnnnn    nnnnnn      TTTTTTTTTTT      iiiiiiii rrrrrrr            AAAAAAA                   AAAAAAA p::::::pppppppp     p::::::pppppppp\n ' +
    '!                                                                                                         p:::::p             p:::::p\n ' +
    '!                                                                                                         p:::::p             p:::::p\n ' +
    '!                                                                                                        p:::::::p           p:::::::p\n ' +
    '!                                                                                                        p:::::::p           p:::::::p\n ' +
