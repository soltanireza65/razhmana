...
Dropzone.options.uploadImage = {
    url: '/admin/category/gearbox/add',
    method: 'post',
...
$('.setSubmitBtn').click(function () {
    ...
    if (flag && selectFiles_uploadImage[0]) {
        ...
        params.append('action', 'gearbox-add');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (myArray[0] == 'successful') {
                    ...
                    window.setTimeout(
                        function () {
                            window.location.replace("/admin/category/gearbox/edit/" + myArray[1]);
                        },
                        2000
                    );
                } else if (data == "empty") {
