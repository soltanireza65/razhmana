...
$('.setSubmitBtn').click(function () {
    ...
    if (name.length > 2 && nickname.length > 2 && validatePhone(mobile) && validateEmail(email) && validatePassword(password) && id > 0) {
...
var len2 = $('#nameAdmin').val().trim().length;
if (len2 > 2) {
    $('#length_nameAdmin').html('<b class="text-success">' + len2 + '</b>');
} else {
    $('#length_nameAdmin').html('<b class="text-danger">' + len2 + '</b>');
}
...
var len3 = $('#nicknameAdmin').val().trim().length;
if (len3 > 2) {
    $('#length_nicknameAdmin').html('<b class="text-success">' + len3 + '</b>');
} else {
    $('#length_nicknameAdmin').html('<b class="text-danger">' + len3 + '</b>');
}
...
var len4 = validatePhone($('#mobileAdmin').val().trim());
if (len4) {
    $('#length_mobileAdmin').html('<b class="text-success">' + temp_lang.validate_phone + '</b>');
} else {
    $('#length_mobileAdmin').html('<b class="text-danger">' + temp_lang.invalidate_phone + '</b>');
...
var len5 = validateEmail($('#emailAdmin').val().trim());
if (len5) {
    $('#length_emailAdmin').html('<b class="text-success">' + temp_lang.validate_email + '</b>');
} else {
    $('#length_emailAdmin').html('<b class="text-danger">' + temp_lang.invalidate_email + '</b>');
...
var len6 = validatePassword($('#passwordAdmin').val().trim());
if (len6) {
    $('#length_passwordAdmin').html('<b class="text-success">' + temp_lang.validate_password + '</b>');
} else {
    $('#length_passwordAdmin').html('<b class="text-danger">' + temp_lang.invalidate_password + '</b>');
