        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (myArray[0] == 'successful') {
                    ...
                    window.setTimeout(
                        function () {
                            // window.location.replace("/admin/category/inventory/edit/" + myArray[1]);
                            window.location.replace("/admin/category/inventory/add");
...
$('#countriesC').on('select2:select', function (e) {
    ...
    let data = {
        action: 'get-city-inventory-by-country-id',
        id: id,
