...
$('.languegeBtn').click(function () {

    let lang=$(this).data('mj-type');
    let data = {
        action: 'time-admin',
        lang: lang,
    };
...
$('.changeLanguageBtn').click(function () {
    ...
    let lang=$(this).data('mj-slug');
    let data = {
        action: 'change-language-admin',
        lang: lang,
    };
    $.ajax({
        type: 'POST',
...
$('#show-edu-video').click(function (){
    window.setTimeout(
        function () {
            $('#show-edu-video-modal').modal('show');
        },
        1000
    );
})
