...
const adminreportItem = $('.mj-admin-monitor-item')
const adminreportItemspan = $('.mj-admin-monitor-item span')
adminreportItemspan.each(function (index) {
    if($(this).text() > 0){
        $(this).parent().parent().addClass("active")
    }else if($(this).text() === 0){
        adminreportItem.removeClass("active")
    }
