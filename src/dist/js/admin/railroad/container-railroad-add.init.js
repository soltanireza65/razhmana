        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (myArray[0] == 'successful') {
                    ...
                    window.setTimeout(
                        function () {
                            // window.location.replace("/admin/category/container/edit/" + myArray[1]);
                            window.location.replace("/admin/category/container-railroad/add");
