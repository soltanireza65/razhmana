...
let edit_personel = $('#edit-personel');
let delete_personel = $('#delete-personel');
...
edit_personel.click(function () {
    if (personel_avatar) {
    } else {
        personel_avatar = $('#imageUpload').attr('value')
    }
    let params = {
        action: 'edit-personel',
        personel_id : edit_personel.data('personel-id'),
...
delete_personel.click(function () {

    let params = {
        action: 'delete-personel',
        personel_id : delete_personel.data('personel-id'),
        token: $('#token2').val()
    }
    $.ajax({
        type: 'POST',
