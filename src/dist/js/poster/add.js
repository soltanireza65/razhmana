...
function setHtmlProperty(loop) {
    ...
    for (let i = 0; i < loop.length; ++i) {
        ...
        temp = temp + '<label> <input type="checkbox" data-option-id="' + loop[i].id + '"> <div class="mj-filter-option-item"> <div class="mj-filter-option-img"> <img src="' + loop[i].image + '" alt="option"> </div><span>' + loop[i].name + '</span></div></label>';
    }
...
Dropzone.options.trailerImages = {
    ...
    transformFile: function(file, done) {
        ...
        confirm.textContent = lang_vars.confirm;
        confirm.classList.add('crop-btn');
...
btnThirdNextItemGeneralPoster.on('click', function () {
    ...
    const params = {
        ...
        cashTruck: cashTruck.is(':checked'),
        leasingTruck: leasingTruck.is(':checked'),
        installmentTruck: installmentTruck.is(':checked'),
        ...
        cashTrailer: cashTrailer.is(':checked'),
        leasingTrailer: leasingTruck.is(':checked'),
        installmentTrailer: installmentTrailer.is(':checked'),
