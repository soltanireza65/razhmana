...
$('#change-user-type-businessman').click(function () {
    changeUserTypeBusinessMan()
})
$('#change-user-type-driver').click(function () {
    changeUserTypeDriver()
})




function changeUserTypeBusinessMan() {
