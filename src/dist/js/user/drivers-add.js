...
$(document).ready(function () {
    ...
    let soldierDZ = " <div style='display: none' id=\"soldier-input\" >\n" +
        ...
        "                            <input type=\"text\"\n" +
        "                                   id=\"cv-military-date\" readonly=\"readonly\" \n" +
        "                                   name=\"cv-military-date\" \n" +
        "                                   class=\"mj-input-filter mj-fw-400 mj-font-13 px-0\"\n" +
        "                                   style=\"min-height: 38px;\" value=\"\"><span>" + lang_vars.cv_millitry_date + "</span>" +
    ...
    let visaDZ = "<div id=\"visa-input1\">\n" +
        ...
        "                                \n" +
        "                            </div>\n" +
        "                               <div style='margin-top: 5PX !important;' class=\"form-floating mb-1 mt-2 col-12 no-pad-left mj-select2-selects\">\n" +
        "                        <div  class=\"mj-input-filter-box mj-driver-add-date-picker\">\n" +
        "                            <input type=\"text\"\n" +
        "                                   id=\"cv-visa-date\"\n" +
    ...
    $('#brithday').persianDatepicker({
        ...
        onSelect: function (unixDate) {
            $('#brithday').parent().removeClass('border-danger');
        }
    });
    ...
    $('#submit-driver').click(function () {
        ...
        if (city_id && cv_name && cv_lname && cv_brith_date && cv_gender && cv_marital_status
            ...
            let params = {
                ...
                cv_visa_location: (cv_visa_location) ? cv_visa_location : [],
                ...
                cv_faviroite_country: (cv_faviroite_country.length > 0) ? cv_faviroite_country : [],
