...
// Bind values
    ...
    foreach ($empRecords as $row) {
        ...
        $tagA = '<a href="/admin/users/info/' . $row['user_id'] . '"
               ...
               <a href="/admin/cargo/' . $row['cargo_id'] . '"
                  data-bs-toggle="tooltip"
                  data-bs-placement="top"
...
if (isset($_SESSION['dt-request-out']) && $_SESSION['dt-request-out'] == "dt-request-out-44") {
...
//print_r($_REQUEST);
    $query1 = "SELECT COUNT(*) AS allcount FROM tbl_requests a 
                INNER JOIN tbl_cargo b ON b.cargo_id=a.cargo_id
    ...
    $query2 = "SELECT COUNT(*) AS allcount FROM tbl_requests a 
                INNER JOIN tbl_cargo b ON b.cargo_id=a.cargo_id
                INNER JOIN tbl_currency e ON b.cargo_monetary_unit=e.currency_id
                LEFT JOIN tbl_cities c ON c.city_id=b.cargo_origin_id
                LEFT JOIN tbl_cities d ON d.city_id=b.cargo_destination_id WHERE 1 ";
    $query3 = "SELECT a.request_id,a.user_id,a.request_date,a.request_status,b.cargo_id,b.cargo_name_{$language},a.request_price,b.cargo_monetary_unit,c.city_name as cityO,d.city_name as cityDesc,e.currency_name  FROM tbl_requests a 
                INNER JOIN tbl_cargo b ON b.cargo_id=a.cargo_id
                INNER JOIN tbl_currency e ON b.cargo_monetary_unit=e.currency_id
                LEFT JOIN tbl_cities c ON c.city_id=b.cargo_origin_id
                LEFT JOIN tbl_cities d ON d.city_id=b.cargo_destination_id WHERE 1 ";
