...
if (isset($_SESSION['dt-cargo']) && $_SESSION['dt-cargo'] == "dt-cargo-44") {

    $query1 = "SELECT COUNT(*) AS allcount FROM tbl_cargo INNER JOIN tbl_cargo_categories ON tbl_cargo_categories.category_id = tbl_cargo.category_id INNER JOIN tbl_users ON tbl_users.user_id = tbl_cargo.user_id WHERE tbl_users.user_type='businessman'  ";
    $query2 = "SELECT COUNT(*) AS allcount FROM tbl_cargo INNER JOIN tbl_cargo_categories ON tbl_cargo_categories.category_id = tbl_cargo.category_id INNER JOIN tbl_users ON tbl_users.user_id = tbl_cargo.user_id WHERE tbl_users.user_type='businessman'  ";
    $query3 = "SELECT * FROM tbl_cargo INNER JOIN tbl_cargo_categories ON tbl_cargo_categories.category_id = tbl_cargo.category_id INNER JOIN tbl_users ON tbl_users.user_id = tbl_cargo.user_id WHERE tbl_users.user_type='businessman' ";
