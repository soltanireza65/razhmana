...
if (isset($_SESSION['dt-task-for-me']) && $_SESSION['dt-task-for-me'] == "dt-task-for-me-44") {
    ...
    $query1 = "SELECT COUNT(*) AS allcount FROM tbl_task WHERE creator_id={$admin_id}";
    $query2 = "SELECT COUNT(*) AS allcount FROM tbl_task WHERE creator_id={$admin_id}  ";
    $query3 = "SELECT * FROM tbl_task WHERE creator_id={$admin_id}";
