    ...
    if (isset($_POST['columns'])) {
        ...
        if (!empty($searchArray) && count($searchArray) > 0) {
            ...
            foreach ($searchArray as $index => $key) {
                ...
                } elseif ($key[0] == 'source_airport_id') {
...
// Bind values
    ...
    foreach ($empRecords as $row) {
        ...
        $id = '<a target="_self"
                     href="/admin/inquiry/air/' . $row['freight_id'] . '"
        ...
        $data[] = array(
            ...
            "source_airport_id" => $source_country,
            "dest_airport_id" => $dest_country,
...
if (isset($_SESSION['dt-inquiry-air']) && $_SESSION['dt-inquiry-air'] == "dt-inquiry-air-44") {

    $query1 = "SELECT COUNT(*) AS allcount FROM tbl_freight_air WHERE 1 ";
    $query2 = "SELECT COUNT(*) AS allcount FROM tbl_freight_air WHERE 1 ";
    $query3 = "SELECT * FROM tbl_freight_air WHERE 1 ";
    getData123($query1, $query2, $query3, ["freight_id", "freight_name", "source_city_id", "dest_city_id", "source_airport_id", "dest_airport_id", "freight_status", "currency_id"], ["freight_name", "freight_submit_date", "freight_start_date", "freight_id", "freight_status"]);
