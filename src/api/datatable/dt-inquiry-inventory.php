...
// Bind values
    ...
    foreach ($empRecords as $row) {
        ...
        $id = '<a target="_self"
                     href="/admin/inquiry/inventory/' . $row['freight_id'] . '"
...
if (isset($_SESSION['dt-inquiry-inventory']) && $_SESSION['dt-inquiry-inventory'] == "dt-inquiry-inventory-44") {

    $query1 = "SELECT COUNT(*) AS allcount FROM tbl_freight_inventory ";
    $query2 = "SELECT COUNT(*) AS allcount FROM tbl_freight_inventory WHERE 1  ";
    $query3 = "SELECT * FROM tbl_freight_inventory WHERE 1";
    getData123($query1, $query2, $query3, ["freight_name", "freight_submit_date", "freight_start_date", "freight_id", "freight_status"], ["freight_name", "freight_submit_date", "freight_start_date", "freight_id", "freight_status"]);
