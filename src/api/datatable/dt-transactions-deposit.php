...
if (isset($_SESSION['dt-transactions-deposit']) && $_SESSION['dt-transactions-deposit'] == "dt-transactions-deposit-44") {
//print_r($_POST);
    $query1 = "SELECT COUNT(*) AS allcount FROM `tbl_transactions` INNER JOIN `tbl_users` ON tbl_transactions.user_id=tbl_users.user_id where tbl_transactions.transaction_type='deposit' ";
    $query2 = "SELECT COUNT(*) AS allcount FROM `tbl_transactions` INNER JOIN `tbl_users` ON tbl_transactions.user_id=tbl_users.user_id where tbl_transactions.transaction_type='deposit' ";
    $query3 = "SELECT * FROM `tbl_transactions` INNER JOIN `tbl_users` ON tbl_transactions.user_id=tbl_users.user_id  where tbl_transactions.transaction_type='deposit' ";
