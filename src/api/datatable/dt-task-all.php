...
//        }
        ...
        $railroad_id = '
                  <a href="/admin/tasks/show/' . $row['task_id'] . '"
                     target="_self"
                     data-bs-toggle="tooltip"
                     data-bs-placement="top"
...
if (isset($_SESSION['dt-task-all']) && $_SESSION['dt-task-all'] == "dt-task-all-44") {

    $query1 = "SELECT COUNT(*) AS allcount FROM tbl_task ";
    $query2 = "SELECT COUNT(*) AS allcount FROM tbl_task WHERE 1 ";
    $query3 = "SELECT * FROM tbl_task WHERE 1";
