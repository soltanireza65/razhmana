...
// Bind values
    ...
    foreach ($empRecords as $row) {
        ...
        $id = '<a target="_self"
                     href="/admin/inquiry/minicargo/' . $row['freight_id'] . '"
...
if (isset($_SESSION['dt-inquiry-minicargo']) && $_SESSION['dt-inquiry-minicargo'] == "dt-inquiry-minicargo-44") {

    $query1 = "SELECT COUNT(*) AS allcount FROM tbl_freight_minicargo tfm WHERE 1 ";
    $query2 = "SELECT COUNT(*) AS allcount FROM tbl_freight_minicargo WHERE 1 ";
    $query3 = "SELECT * FROM tbl_freight_minicargo WHERE 1 ";
    getData123($query1, $query2, $query3, ["freight_id",   "freight_submit_date", "freight_start_date", "freight_status", "currency_id"], ["freight_name", "freight_submit_date", "freight_start_date", "freight_id", "freight_status"]);
