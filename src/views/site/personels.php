...
enqueueStylesheet('qrcodecss', '/dist/css/personel.css');
...
enqueueScript('dropzone-js', '/dist/js/site/personels.js');
...
$personel_ref_code = $_REQUEST['id'];


$personel = CV::getPersonelById($personel_ref_code);
$personel = $personel->status == 200 ? $personel->response[0] : [];

$language = (isset($_COOKIE['language'])) ? $_COOKIE['language'] : 'fa_IR';
$slug_personel_name = 'personel_name_' . $language;
$slug_personel_lname = 'personel_lname_' . $language;
$slug_personel_side = 'personel_side_' . $language;
$slug_personel_side = 'personel_side_' . $language;
$slug_personel_description = 'personel_description_' . $language;
...
<div>
    ...
    <div class="mj-links-main">
        <div class="mj-site-name">
            nTirApp
        </div>
        <div class="mj-direct-download">
            <a target="_blank" href="/login/<?= $personel->personel_ref_code ?>">
   ...
   <?=$lang['L_cafebazar_download']?>
    ...
    <main class="mj-links-main2 container">
        <div id="header-all-card">
            <div class="mj-personel-head">
                <img id="company-logo" src="/dist/images/ntirapp-white.svg" alt="ntilogo">
                <div id="company-name"><?= $lang['ntirapp_org_title'] ?></div>
                <div id="circle1"></div>
                <div id="circle2"></div>
                <div id="circle3"></div>
            </div>
            <div id="personel-name-img">
                <div class="mj-personel-image">
                    <img src="<?= Utils::fileExist($personel->personel_avatar, POSTER_DEFAULT) ?>" alt="prsl-img">
                </div>
                <div class="mj-personel-name mt-2">
                    <?= $personel->$slug_personel_name . ' ' . $personel->$slug_personel_lname ?>
                </div>
<!--                <div class="mj-personel-job mt-1">-->
<!--                    --><?php //= $personel->$slug_personel_side ?>
<!--                </div>-->
            </div>
        </div>

        <div class="mj-personel-website">
            <a target="_blank" href="/login/<?= $personel->personel_ref_code ?>">
                www.nTirApp.com
            </a>
        </div>
        <div class="mj-personel-info-card">


            <div class="mj-personel-info-item phone">
                <div class="mj-personel-item-icon">
                    <div class="fa-phone icon"></div>
                    <span class="mj-personel-info-item-title"><?= $lang['phone_static']; ?></span>
                </div>
                <div class="mj-personel-item-value">
                    <a href="tel:+<?= $personel->personel_home_number_code ?><?= $personel->personel_home_number ?>"><?= $personel->personel_home_number_code ?><?= $personel->personel_home_number ?></a>
                </div>
            </div>
            <div class="mj-personel-info-item mobile">
                <div class="mj-personel-item-icon">
                    <div class="fa-mobile icon"></div>
                    <span class="mj-personel-info-item-title"><?= $lang['user_mobile']; ?></span>
                </div>
                <div class="mj-personel-item-value">
                    <a href="tel:+<?= $personel->personel_mobile_code ?><?= $personel->personel_mobile ?>"> <?= $personel->personel_mobile_code ?><?= $personel->personel_mobile ?></a>

                </div>
            </div>
            <div class="mj-personel-info-item">
                <div class="mj-personel-item-icon">
                    <div class="fa-whatsapp icon1"></div>
                    <span class="mj-personel-info-item-title"><?= $lang['support_whatsapp_small']; ?></span>
                </div>
                <div class="mj-personel-item-value">
                    <a href="https://wa.me/+<?= $personel->personel_whatsapp_code ?><?= $personel->personel_whatsapp ?>"><?= $personel->personel_whatsapp_code ?><?= $personel->personel_whatsapp ?></a>

                </div>
            </div>
            <div class="mj-personel-info-item email">
                <div class="mj-personel-item-icon">
                    <div class="fa-envelope icon"></div>
                    <span class="mj-personel-info-item-title"><?= $lang['email']; ?></span>
                </div>
                <div class="mj-personel-item-value">
                    <a href="mailto:<?= $personel->personel_email ?>"><?= $personel->personel_email ?></a>
                </div>
            </div>

        </div>
        <div class="mj-personel-desc">
            <?= $personel->$slug_personel_description ?>
        </div>
...
<!--                        <span>--><?php //= $lang['d_cargo_ticket'] ?><!--</span>-->
<!--                    </a>-->
