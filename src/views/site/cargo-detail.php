...
if ($cargo->status == 200) {
    ...
    if (!in_array($cargo->CargoStatus, ['pending', 'canceled', 'rejected'])) {
        ...
        enqueueScript('cargo-detail-init', '/dist/js/site/cargo-detail.init.js');

        getHeader($lang['d_cargo_detail_title']);

        $sourceOutput = $cargo->CargoOriginCity . ' - ' . $cargo->CargoOriginCountry->CountryName;
        $destOutput = $cargo->CargoDestinationCity . ' - ' . $cargo->CargoDestinationCountry->CountryName;
        ?>
        <div id="map-detail"
                                ...
                                <div class="cargo-detail col-6">
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div>
                                            ...
                                            <div class="mj-d-cargo-item-value"><?= $cargo->CargoId ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <a id="share-data" href="javascript:void(0);" class="d-none"
           data-link="<?= SITE_URL; ?>/cargo-ads/<?= $_REQUEST['id'] ?>"
