...
function getHeader($title = '', $version = '1.2.0', $meta_desc = '', $display_lang_modal = true, $display_menu = true)
{
...
//    }
    ...
    <head>
        ...
        <?php if (!empty($meta_desc) && !is_null($meta_desc)) { ?>
...
<!--            <link rel="stylesheet" type="text/css" href="/dist/css/drprv-ltr.css?v=--><?php //= $version ?><!--">-->
    ...
    <?php
    if ($display_menu) {
        Menu::getHeaderMenu($display_lang_modal);
    }
    }

    function getFooter($version = '1.2.0', $display_footer = false)
    {
    ...
    ?>
    <div class="mj-backbtn-background">
...
function getLoginHeader($title = '', $version = '1.2.0')
{
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/dist/libs/jquery/jquery-3.6.4.min.js?v=<?= $version ?>"/>
        <link rel="stylesheet" type="text/css" href="/dist/libs/bootstrap/css/bootstrap.rtl.min.css?v=<?= $version ?>"/>
        <link rel="stylesheet" type="text/css"
              href="/dist/libs/jquery-toast-plugin/jquery.toast.min.css?v=<?= $version ?>"/>
        <?php
