...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('notifications-init-js', '/dist/js/driver/notifications.init.js');
                                    ...
                                    <table id="notification-table"
                                        ...
                                        foreach ($notifications->response as $key => $item) {
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <a href="/driver/notification/<?= $item->NotificationId ?>"
                                                       class="mj-btn-more">
                                    ...
                                    <table id="group-notifications-table"
                                        ...
                                        foreach ($groupNotifications->response as $key => $item) {
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <a href="/driver/notification/group/<?= $item->NotificationId ?>"
                                                       class="mj-btn-more">
                                                        <?= $lang['d_button_detail'] ?>
                                                    </a>
                                                </td>
