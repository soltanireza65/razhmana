...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('transactions-init', '/dist/js/businessman/transactions.init.js');
    ...
    <main class="container" style="padding-bottom: 180px;">
        <div class="row">
            <div class="col-12 mt-3">
                            ...
                            <div class="col-auto">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu mj-dropdown-menu">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="/businessman/transactions"
                                            ...
                                            <div class="col-6">
                                                <a href="/businessman/transactions/completed"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/businessman/transactions/rejected"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/businessman/transactions/pending"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/businessman/transactions/expired"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/businessman/transactions/unpaid"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                            ...
                            <table id="transactions-table"
                                ...
                                foreach ($records->response as $key => $item) {
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="/businessman/tx/<?= $item->TransactionId ?>" class="mj-btn-more">
                ...
                <div class="card mj-card">
                    <div class="card-body">
                        <h4 class="mj-b-icon-title d-block mj-fw-700 mj-font-13 mt-0 mb-3"><?=$lang['table_guide']?></h4>
