...
if (User::userIsLoggedIn()) {
    ...
    if ($cargo->status == 200) {
        ...
        if (!in_array($cargo->CargoStatus, ['pending', 'canceled', 'rejected'])) {
            ...
            $request = Driver::getMyRequestForCargo($cargo->CargoId, $user->UserId);
            $requests = Businessman::getCargoDrivers($cargo->BusinessmanId, $cargo->CargoId);
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-center">
                                                <input type="hidden" id="token-cancel" name="token-cancel"
                                                       value="<?= Security::initCSRF('cancel-request') ?>">
                        ...
                        <div class="col-12">
                            <div class="mj-info-box mb-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <div class="mj-fw-600 mj-font-13 mb-1"><?= $cargo->BusinessmanDisplayName ?></div>
                                        <div class="mj-fw-600 mj-font-13">
                                            <bdi><?= $cargo->BusinessmanMobile ?> </bdi>
                                        </div>
                                    </div>
                                    <a href="tel:<?= $cargo->BusinessmanMobile ?>" class="mj-btn-2 mj-btn-info">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <button type="button" class="mj-btn-2 mj-btn-primary shadow-none w-100"
                                                onclick="window.location.href='/driver/start-transportation/<?= $request->RequestId ?>'">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if ($user->UserStatus != 'suspend' && !in_array($cargo->CargoStatus, ['pending', 'rejected', 'completed'])) {
                            if (empty($request) || (!empty($request) && !in_array($request->RequestStatus, ['pending', 'accepted', 'progress', 'completed']))) {
                                ...
                                <button type="button" class="mj-d-floating-button mj-d-floating-button-top"
                                        onclick="window.location.href = '/driver/send-request/<?= $cargo->CargoId ?>'"><?= $lang['u_recommended_price_2'] ?></button>
                                <?php
                            }
                        }
                        ...
                        if (!empty($request) && $request->RequestStatus == 'progress') {
                            ?>
                            <button type="button"
                                    onclick="window.location.href = '/driver/end-transportation/<?= $request->RequestId ?>'"
                            ...
                            <div class="mj-d-cargo-card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center flex-nowrap overflow-auto">
                                        ...
                                        <?php
                                        if (Complaint::checkCanSendComplaint($cargo->CargoId, $request->RequestId, $user->UserId, $cargo->BusinessmanId)) {
                                            ?>
                                    ...
                                    <div class="cargo-detail col-6">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="mj-d-cargo-item-value"><?= ($_COOKIE['language'] == 'fa_IR') ? Utils::jDate('Y/m/d', $cargo->CargoStartTransportation) : date('Y-m-d', $cargo->CargoStartTransportation) ?></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <div class="position-relative">
                                                <img src="/dist/images/icons/house-signal.svg"
                                                     class="mj-d-cargo-item-icon <?= ($cargo->CargoGreen == "yes") ? "me-2" : ""; ?>"
                                            ...
                                            <div>
                                                <div class="mj-d-cargo-item-title <?= ($cargo->CargoGreen == "yes") ? "" : "ps-2"; ?>"><?= $lang['d_cargo_customs_of_origin'] ?>
                                                    :
                                                </div>
                                                <div class="mj-d-cargo-item-value ps-2">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <input type="hidden" id="token" name="token"
                                                       value="<?= Security::initCSRF('extra-expenses') ?>">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mj-table mj-table-stripped mj-table-row-number">
                                            <tbody>
                                            <?php
                                            $expenses = Driver::getExtraExpensesList($request->RequestId);
                        ...
                        <div class="mj-d-cargo-card mb-3">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center flex-nowrap overflow-auto">
                                    ...
                                    <a href="whatsapp://send?text=<?= $cargo->CargoName . $Settings['share_text']; ?>%0A<?= SITE_URL; ?>/cargo-ads/<?= $_REQUEST['id'] ?>"
                                       class="mj-btn mj-d-btn-whatsapp me-2"
                                       style="flex: 0 0 auto; min-height: 34px;"
                                       target="_blank">
                                        <img src="/dist/images/icons/whatsapp.svg" class="me-1" alt="whatsapp">
