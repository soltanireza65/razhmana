...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('wallet-init-js', '/dist/js/businessman/wallet.init.js');
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="mj-custom-select mb-2">
                                                <select name="withdraw-dest" id="withdraw-dest"
                                                        data-width="100%">
                                                    <option value="-1">
                                            ...
                                            <div class="mj-add-credit-card">
                                                <a href="/businessman/add-card"><?= $lang['wallet_add_card'] ?></a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="mj-card">
                    <div class="card-body">
                        <div class="mj-wallet-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="mj-add-value-btn text-center">
                                <a class="px-3"
                                   href="/businessman/transactions"><?= $lang['wallet_transactions_history'] ?></a>
                            </div>
                ...
                <div class="mj-card">
                    <div class="card-body">
                        <div class="mj-wallet-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="mj-add-value-btn text-center">
                                <a class="px-3" href="/businessman/credit-cards"><?= $lang['credit_cards_list'] ?></a>
                            </div>
                        </div>
                    </div>
                </div>
