...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('credit-cards-init', '/dist/js/driver/credit-cards.init.js');
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu mj-dropdown-menu">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <a href="/driver/credit-cards/accepted"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/driver/credit-cards/rejected"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/driver/credit-cards/pending"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
