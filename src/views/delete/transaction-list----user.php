...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('transactions-init', '/dist/js/user/transactions.init.js');
    enqueueScript('all-init-js', '/dist/js/user/all.init.js');
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu mj-dropdown-menu">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <a href="/user/transactions/completed"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/user/transactions/rejected"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/user/transactions/pending"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/user/transactions/expired"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color me-2"
                                            ...
                                            <div class="col-6">
                                                <a href="/user/transactions/unpaid"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    <span class="mj-filter-color"
                                                          style="background-color: #9f03e8"></span>
                                                    <span style="padding-right: 5px;"><?= $lang['d_filter_unpaid'] ?></span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <table id="transactions-table"
                                ...
                                foreach ($records->response as $key => $item) {
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="/user/tx/<?= $item->TransactionId ?>" class="mj-btn-more">
                ...
                <div class="card mj-card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="mj-trx-expire">
                                    <?= $lang['d_filter_expired'] ?>
                                </span>
                            </div>

                            <div class="col-6">
                                <span class="mj-trx-wait">
