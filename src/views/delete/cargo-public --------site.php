...
if (isset($_COOKIE['user-type']) && !empty($_COOKIE['user-type'])) {
    $user_type = $_COOKIE['user-type'];
    if ($user_type == 'driver') {
        header('location:/driver/cargo/' . $_REQUEST['id']);
    }
}
...
//        enqueueStylesheet('ol-css', 'https://unpkg.com/openlayers/dist/ol.css');
...
//        enqueueScript('polyfill', 'https://cdn.polyfill.io/v3/polyfill.min.js?features=fetch,requestAnimationFrame,Element.prototype.classList,TextDecoder');
//        enqueueScript('cloudflare', 'https://cdnjs.cloudflare.com/ajax/libs/core-js/3.18.3/minified.js');
//        enqueueScript('ol-js', 'https://unpkg.com/openlayers/dist/ol-debug.js');
        enqueueScript('map-js', '/map/assets/index.11536adb.js');
        enqueueScript('cargo-detail-init', '/dist/js/driver/cargo-detail.init.js');
        enqueueScript('menu-init', '/dist/js/driver/dashboard.init.js');
        enqueueScript('cargo-public', '/dist/js/site/cargo-public.init.js');
...
//        $destOutput = '';
//        if (isset(($cargo->CargoDestination)->id)) {
//            $destination = ($cargo->CargoDestination)->id;
...
//        }
//        $sourceOutput = '';
//        if (isset(($cargo->CargoOrigin)->id)) {
//            $origin = ($cargo->CargoOrigin)->id;
...
//        }
        ...
        $destOutput = $cargo->CargoOriginCity . ' - ' . $cargo->CargoOriginCountry->CountryName;
        $sourceOutput = $cargo->CargoDestinationCity . ' - ' . $cargo->CargoDestinationCountry->CountryName;
        ?>
        <main class="container" style="padding-bottom: 70px;">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="mj-d-cargo-card mb-3">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-fill">
                                    <h2 class="mj-d-cargo-item-header mt-0 mb-2"><?= $cargo->CargoName ?></h2>
                            ...
                            <div class="row">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="mj-d-cargo-item-value">
                                                <?php
                                                if ($cargo->CargoStatus == 'accepted' && $cargo->CargoStartTransportation <= time() && ($cargo->CargoStartTransportation + CARGO_READY_TO_LOAD) >= time()) {
                                                    echo $lang['u_date_ready_to_load'];
                                                } else {
                                                    echo ($language == 'fa_IR') ? Utils::jDate('Y/m/d', $cargo->CargoStartTransportation) : date('Y-m-d', $cargo->CargoStartTransportation);
                                                } ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="position-relative">
                                            <img src="/dist/images/icons/house-signal.svg"
                                                 ...
                                                 alt="customs-of-origin"/>
                                            <!-- todo Green -->
                                            <?= ($cargo->CargoGreen == "yes") ? '<div class="mj-green-road-blob"></div>' : ""; ?>
                                        </div>
                                        <div>
                                            <div class="mj-d-cargo-item-title"><?= $lang['d_cargo_customs_of_origin'] ?>
                                                :
                                            </div>
                                            <div class="mj-d-cargo-item-value <?= ($cargo->CargoGreen == "yes") ? "ps-2" : "ps-0"; ?>">
                                                <?php if ($cargo->CargoGreen == "yes") {
                                                    echo $lang['u_green_street_customs'];
                                                } else {
                                                    echo $cargo->CargoCustomsOfOriginCity;
                                                } ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cargo-detail col-6">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            <div class="mj-d-cargo-item-title"><?= $lang['u_request_car_type'] ?>:</div>
                                            <div class="mj-d-cargo-item-value">
                                ...
                                <div class="cargo-detail col-6">
                                    <div class="d-flex align-items-center mb-1">
                                        <img src="/dist/images/icons/house-signal-1.svg"
                                             class="mj-d-cargo-item-icon me-2" alt="destination-customs"/>
                                        <div>
                                            <div class="mj-d-cargo-item-title"><?= $lang['d_cargo_destination_customs'] ?>
                                                :
                                            </div>
                                            <div class="mj-d-cargo-item-value"><?= $cargo->CargoDestinationCustomsCity ?></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="progress mt-1" dir="ltr">
                                                <div class="progress-bar <?= ($cargo->CargoStatus == 'completed') ? 'bg-success' : '' ?>"
                                                     ...
                                                     aria-valuenow="0"
                                                     style="width: <?= $cargo->CargoCarCount ?>">
                                                    <?= $cargo->CargoCarCount ?>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex flex-row-reverse">
                                    ...
                                    if (!empty($cargo->CargoImages)) {
                                        ...
                                        ?>
                                        <a href="#gallery-modal" data-bs-toggle="modal" class="mj-d-cargo-img-overlay"
                                           data-gallery>
                    ...
                    <?php
                    if (isset($cargo->CargoDescription) && !empty($cargo->CargoDescription)) {
                        ?>
                        <div class="mj-d-cargo-card mb-3">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="mj-d-cargo-item-desc">
                    ...
                    <div class="mj-d-cargo-card mb-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center flex-nowrap overflow-auto">
                                ...
                                <a href="whatsapp://send?text=<?= $cargo->CargoName . $Settings['share_text']; ?>"
                                   class="mj-btn mj-d-btn-whatsapp me-2"
                                   style="flex: 0 0 auto; min-height: 34px;"
                                   target="_blank">
                                    <img src="/dist/images/icons/whatsapp.svg" class="me-1" alt="whatsapp">
                                ...
                                <a href="https://t.me/share/url?url=<?= SITE_URL; ?>/cargo-ads/<?= $_REQUEST['id'] ?>&text=<?= $cargo->CargoName . $Settings['share_text']; ?>"
                    ...
                    <!-- end share btn -->
                    <?php if (isset($_COOKIE['user-type']) && in_array($_COOKIE['user-type'], ['driver'])) { ?>
                        <button type="button" class="mj-d-floating-button mj-d-floating-button-top"
                                onclick="window.location.replace('/driver/send-request/<?= $cargo->CargoId ?>')"><?= $lang['d_send_request'] ?></button>
                    <?php } elseif (isset($_COOKIE['user-type']) && in_array($_COOKIE['user-type'], ['guest'])) { ?>
                        <button type="button" class="mj-d-floating-button mj-d-floating-button-top"
                                onclick="window.location.replace('/')"><?= $lang['u_chose_user_type'] ?></button>
        ...
        <a id="share-data" href="javascript:void(0);" class="d-none" data-link="<?= SITE_URL; ?>/cargo-ads/<?= $_REQUEST['id'] ?>"
