...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('wallet-init-js', '/dist/js/user/wallet.init.js');
                                                ...
                                                <div class="mb-3">
                                                    <div class="mj-input-filter-box pe-1">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div class="mj-font-12 me-1" id="file-name">
                    ...
                    foreach ($balance->response as $index => $item) {
                        if ($index == 0) {
                            ...
                            <div class="mj-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <img src="/dist/images/icons/inbox-out.svg" class="mj-d-icon-box me-2"
                                             alt="wallet">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mj-custom-select mb-2">
                                                        <select name="withdraw-dest-<?= $index ?>"
                                                                id="withdraw-dest-<?= $index ?>"
                                                    ...
                                                    <div class="mj-add-credit-card">
                                                        <a href="/user/add-card"><?= $lang['wallet_add_card'] ?></a>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="mj-card">
                        <div class="card-body">
                            <div class="mj-wallet-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="mj-add-value-btn text-center">
                                    <a class="px-3"
                                       href="/user/transactions"><?= $lang['wallet_transactions_history'] ?></a>
                                </div>
                    ...
                    <div class="mj-card">
                        <div class="card-body">
                            <div class="mj-wallet-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="mj-add-value-btn text-center">
                                    <a class="px-3" href="/user/credit-cards"><?= $lang['credit_cards_list'] ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
