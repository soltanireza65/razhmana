...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('my-cargoes-init', '/dist/js/driver/my-requests.init.js');
    getHeader($lang['u_driver_myrequests_title']);
            ...
            <div class="mj-wallet-head-blue">
                ...
                <div class="mj-transaction-list">
                    <div class="mj-trx-head">
                        <div class="mj-trx-list-title"><?= $lang['u_my_request_and_cargos'] ?> :</div>
                        <div class="mj-trx-operation-btns">
                            ...
                            <div class="mj-filter-dropdown mj-mycargo-items ">
                                ...
                                <div class="mj-mycargo-list-filter-item" style="visibility: hidden !important;">
                                    <label>
    ...
    <script>
        ...
        let request_status = ['<?= !empty($_REQUEST['status']) ? $_REQUEST['status'] : 'all' ?>'];
