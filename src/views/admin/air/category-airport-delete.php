...
// end roles 1
         ...
         * Get Airport By ID
         */
        $Result = Air::getAirportInfoById($id);
        $data = [];
        ...
        if (empty($data)) {
            header('Location: /admin/category/airport');
        }
        ...
        enqueueScript('airport-delete', '/dist/js/admin/air/airport-delete.init.js');

        getHeader($lang['delete_airport'], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["delete_airport"]; ?></h5>
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="text-danger"><?= $lang['delete_airport_desc']; ?></p>
                                    <p class="text-muted mb-2 font-16">
                                        <span class="ms-2"><?= $lang["name_airport"]; ?> : </span>
                                        <strong id="airport_name">
                                            <?= (!empty(array_column(json_decode($data->airport_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                array_column(json_decode($data->airport_name, true), 'value', 'slug')[$_COOKIE['language']] : ""; ?>
                                        </strong>
                                    </p>
                                    ...
                                    <p class="text-muted mb-2 font-13">
                                        ...
                                        <strong>
                                            <?php
                                            if ($data->airport_status == "active") {
                                                echo "<span class='badge badge-soft-success font-12'>" . $lang['active'] . "</span>";
                                            } elseif ($data->airport_status == "inactive") {
                                                echo "<span class='badge badge-soft-warning font-12'>" . $lang['inactive'] . "</span>";
                                            } else {
                                                echo "<span class='badge badge-soft-danger font-12'>" . $data->airport_status . "</span>";
                                            }
                                            ?>
                                        </strong>
                                    </p>
