...
// end roles 1
        ...
        /**
         * Get Count Airport Status
         */
        $Result = Air::getCountAirportsFromChart();
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['airport_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/airport/add"
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="airport_id,airport_name,city_name,airport_status,airport_priority,airport_options"
                                       data-tj-address="dt-airport"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_airport']; ?></h4>
                                </div>
                            </div>
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-airports'] = "dt-airports-44"; ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'tempp' => [
