...
// end roles 1
         ...
         */
        $result = Air::getInquiryInfoById($id);
        $data = [];
        if ($result->status == 200) {
            $data = $result->response[0];
        }
        if (empty($data)) {
            header('Location: /admin/inquiry/air');
        }
//print_r($data);
        /**
         * Get User Info By Id
         ...
         * Get airport Name
         */
        $resultStation = Air::getMultiPortsByIDs("$data->source_airport_id ,$data->dest_airport_id");
        $dataStation = [];
         ...
         * Get Cargo Category
         */
        $resultCargoCategory = Air::getAllCategoryAirCargo('active');
        $cargoCategoryInfo = [];
         ...
         * Get All Packing
         */
        $resultPacking = Air::getAllCategoryAirPackingActive();
        $dataPacking = [];
        ...
        enqueueScript('inquiry-air-info', '/dist/js/admin/air/inquiry-air-info.init.js');

        getHeader($lang["inquiry_air_title"], [
            'lang' => $lang,
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <td><?= $lang["a_price_value"]; ?> :</td>
                                        <td>
                                            <span id="change_inquiry_price_value"
                                                  data-type="number"
                                                  data-bs-toggle="tooltip"
                                                  data-bs-placement="top"
                                                  title="<?= $lang['click_for_edit']; ?>"
                                                  data-tj-type="freight_price_value">
                                                 <?= number_format($data->freight_price_value); ?>
                                            </span>
                                            <span id="change_inquiry_currency_value"
                                                  data-type="select"
                                                  data-bs-toggle="tooltip"
                                                  data-bs-placement="top"
                                                  title="<?= $lang['click_for_edit']; ?>"
                                                  data-tj-type="currency_id_value"> <?php
                                                if (!empty($dataAllCurrencies)) {
                                                    foreach ($dataAllCurrencies as $loop) {
                                                        if ($loop->currency_id == $data->currency_id_value) {
                                                            echo (!empty(array_column(json_decode($loop->currency_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                                array_column(json_decode($loop->currency_name, true), 'value', 'slug')[$_COOKIE['language']] : $data->currency_id_value;
                                                            break;
                                                        }
                                                    }
                                                }
                                    ...
                                    <tr>
                                        <td><?= $lang["a_freight_declaration"]; ?> :</td>
                                        <td>
                                            <?= $data->freight_declaration; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="align-items-center d-flex justify-content-around list-group-item">
                                                    <?= $lang['a_source_airport']; ?>
                                                    <span>
                                                         <?php
                                                         if (!empty($dataStation)) {
                                                             foreach ($dataStation as $loop) {
                                                                 if ($loop->airport_id == $data->source_airport_id) {
                                                                     echo (!empty(array_column(json_decode($loop->airport_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                                         array_column(json_decode($loop->airport_name, true), 'value', 'slug')[$_COOKIE['language']] : $data->source_airport_id;
                                                                 }
                                                             }
                                                         }
                                                         ?>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="align-items-center d-flex justify-content-around list-group-item">
                                                    ...
                                                    <span>
                                                          ...
                                                          if (!empty($dataStation)) {
                                                              foreach ($dataStation as $loop) {
                                                                  if ($loop->airport_id == $data->dest_airport_id) {
                                                                      echo (!empty(array_column(json_decode($loop->airport_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                                          array_column(json_decode($loop->airport_name, true), 'value', 'slug')[$_COOKIE['language']] : $data->dest_airport_id;
                                                                  }
                                                              }
                                                          }
                                                          ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <td><?= $lang["a_freight_contract"]; ?> :</td>
                                        <td>
                                             <span id="change_inquiry_contract"
                                                   data-type="text"
                                                   data-bs-toggle="tooltip"
                                                   data-bs-placement="top"
                                                   title="<?= $lang['click_for_edit']; ?>"
                                                   data-tj-type="freight_contract">
                                                  <?= $data->freight_contract; ?>
                                             </span>
                                        </td>
                                    </tr>
