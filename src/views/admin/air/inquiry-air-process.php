...
// end roles 1
        ...
        /**
         * Get All Inquiry Air process Status
         */
        $Result = Air::getAllInquiryAirByStatus('process');
        $Data = [];
        ...
        if ($flagSlug) {
            ...
            <div class="row justify-content-between mb-3">
                <div class="col-auto">
                    <h4 class="header-title"><?= $lang["inquiry_air_title"]; ?></h4>
                </div>
                <div class="col-sm-6">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="text-sm-end">
                                            <a href="/admin/inquiry/air/<?= $DataITEM->freight_id; ?>"
                                               class="action-icon">
                                                <i class="mdi mdi-eye"
                                                   data-bs-toggle="tooltip"
                                                   data-bs-placement="top"
