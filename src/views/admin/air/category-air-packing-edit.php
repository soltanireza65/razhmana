...
// end roles 1
         ...
         * Get packing By ID
         */
        $Result = Air::getCategoryAirPackingById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/air-packing');
        }
        ...
        enqueueScript('air-packing-edit', '/dist/js/admin/air/air-packing-edit.init.js');

        getHeader($lang["air_packing_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["air_packing_edit"]; ?></h5>
                            <div class="row">
                                <?php
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                ...
                                <a href="/admin/category/air-packing"
