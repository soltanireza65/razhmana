...
// end roles 1
         ...
         * Get All Cities
         */
        $resultAllCities = Location::getAllCitiesSomeValues('air');
        $dataAllCities = [];
        ...
        enqueueScript('airport-edit', '/dist/js/admin/air/airport-edit.init.js');

        getHeader($lang["airport_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["airport_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->airport_name) as $temp) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        class="<?= ($Data->airport_status == "active") ? "active" : ""; ?>
                                         setSubmitBtn btn w-sm btn-soft-success waves-effect shadow-none waves-light"
                                        data-id="<?= $Data->airport_id; ?>"
                                        data-style="zoom-in">
                                    <?= $lang["active_submit"]; ?>
                                </button>
                                <button id="btnInactive" type="button"
                                        class="<?= ($Data->airport_status == "inactive") ? "active" : ""; ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($Data->airport_status == "active") {
                                                ...
                                                echo "<span class='badge badge-soft-danger font-13'>" . $Data->airport_status . "</span>";
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <?php
                                    if (!empty($Data->airport_options)) {

                                        $temp = json_decode($Data->airport_options);
                                        $name = "";
