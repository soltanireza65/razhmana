...
// end roles 1
        ...
        enqueueScript('air-packing-add', '/dist/js/admin/air/air-packing-add.init.js');

        getHeader($lang["air_packing_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["air_packing_add"]; ?></h5>
                            <div class="row">
                                <?php
