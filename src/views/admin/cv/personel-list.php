        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="/admin/personel/add" class="btn btn-primary mj-personel-add-btn" >
                                <?=$lang['add']?>
                            </a>

                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['personel_list']; ?></h4>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="personel_id,personel_name_fa_IR,personel_lname_fa_IR,personel_create_at,personel_action"
                                       data-tj-address="dt-personel"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-personel'] = "dt-personel-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
