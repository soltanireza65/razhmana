...
// end roles 1
         ...
         * Get wagon By ID
         */
        $Result = VisaLocation::getVisaLocationById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/wagon');
        }
        ...
        enqueueScript('visa-location-edit', '/dist/js/admin/driver-services/visa-location-edit.js');

        getHeader($lang["visa_location_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["visa_location_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->visa_name) as $temp) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <?php
                                    if (!empty($Data->visa_options)) {

                                        $temp = json_decode($Data->visa_options);
                                        $name = "";
