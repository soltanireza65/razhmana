...
// end roles 1
         ...
         * Get All wagon
         */
        $Result = VisaLocation::getAllVisaLocation();
        $Data = [];
        ...
        getHeader($lang["visa_location_list"], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['visa_location_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/visa-location/add"
                                    ...
                                    if (!empty($Data)) {
                                        ...
                                        foreach ($Data as $Loop) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if ($Loop->visa_status == "active") {
                                                        echo "<span class='badge badge-soft-success font-12'>" . $lang['active'] . "</span>";
                                                        $status_active += 1;
                                                    } elseif ($Loop->visa_status == "inactive") {
                                                        echo "<span class='badge badge-soft-warning font-12'>" . $lang['inactive'] . "</span>";
                                                        $status_inactive += 1;
                                                    } else {
                                                        echo "<span class='badge badge-soft-danger font-12'>" . $Loop->visa_status . "</span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/visa-location/edit/<?= $Loop->visa_id; ?>"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_visa_location']; ?></h4>
                                </div>
                            </div>
