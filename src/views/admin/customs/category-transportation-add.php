...
// end roles 1
        ...
        enqueueScript('wagon-add', '/dist/js/admin/customs/transportation-add.init.js');

        getHeader($lang["customs_transportation_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["customs_transportation_add"]; ?></h5>
                            <div class="row">
                                <?php
