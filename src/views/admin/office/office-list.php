...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['list_offices']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/office/add"
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='25' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="office_id,office_mobile,office_email,office_status,office_create_at,action"
                                       data-tj-address="dt-offices"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-office'] = "dt-office-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
