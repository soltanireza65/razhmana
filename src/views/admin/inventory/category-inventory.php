...
// end roles 1
        ...
        /**
         * Get Count inventory Status
         */
        $Result = Inventory::getCountInventoryFromChart();
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['inventory_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/inventory/add"
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="inventory_id,inventory_name,city_name,inventory_status,inventory_priority,inventory_options"
                                       data-tj-address="dt-inventory"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_inventory']; ?></h4>
                                </div>
                            </div>
                            ...
                            <div class="text-start mt-3">
                                <?php
                                $all = (isset($Result['all'])) ? $Result['all'] : 0;
                                $active = (isset($Result['active'])) ? $Result['active'] : 0;
                                $inactive = (isset($Result['inactive'])) ? $Result['inactive'] : 0;
                                ?>
                                <p class="text-muted mb-2 font-13">
                                    ...
                                    <span class="ms-2"
                                          data-plugin="counterup"><?= $all; ?></span>
                                </p>
                                ...
                                <p class="text-muted mb-2 font-13">
                                    ...
                                    <span class="ms-2" data-plugin="counterup"><?= $active; ?></span>
                                </p>
                                ...
                                <p class="text-muted mb-2 font-13">
                                    ...
                                    <span class="ms-2" data-plugin="counterup"><?= $inactive; ?></span>
                                </p>
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-inventory'] = "dt-inventory-44"; ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'tempp' => [
                            ['name' => $lang['active'], 'count' => $active],
                            ['name' => $lang['inactive'], 'count' => $inactive],
                        ],
                    ];
