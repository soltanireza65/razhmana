...
// end roles 1
        ...
        enqueueScript('inventory-delete', '/dist/js/admin/inventory/inventory-delete.init.js');

        getHeader($lang['delete_inventory'], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["delete_inventory"]; ?></h5>
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="text-danger"><?= $lang['delete_inventory_desc']; ?></p>
                                    <p class="text-muted mb-2 font-16">
                                        <span class="ms-2"><?= $lang["name_inventory"]; ?> : </span>
                                        <strong id="inventory_name">
                                            <?= (!empty(array_column(json_decode($data->inventory_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                array_column(json_decode($data->inventory_name, true), 'value', 'slug')[$_COOKIE['language']] : ""; ?>
                                        </strong>
                                    </p>
                                    ...
                                    <p class="text-muted mb-2 font-13">
                                        ...
                                        <strong>
                                            ...
                                            if ($data->inventory_status == "active") {
                                                ...
                                                echo "<span class='badge badge-soft-danger font-12'>" . $data->inventory_status . "</span>";
                                            }
                                            ?>
                                        </strong>
                                    </p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                ...
                                <a href="/admin/category/inventory/edit/<?= $data->inventory_id; ?>"
