...
// end roles 1
        ...
        enqueueScript('inventory-add', '/dist/js/admin/inventory/inventory-add.init.js');

        getHeader($lang["inventory_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["inventory_add"]; ?></h5>
                            <div class="row">
                                <?php
