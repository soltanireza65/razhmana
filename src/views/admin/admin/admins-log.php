...
// start roles 2
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['admins_log']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='25' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="log_id,admin_name,log_date,log_detail,log_os,log_browser"
                                       data-tj-address="dt-admins-log"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-admins-log'] = "dt-admins-log-44"; ?>">
            <?php
