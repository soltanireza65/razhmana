<?php
$pageSlug = ['a_request_out_pending', 'a_request_out_accepted', 'a_request_out_rejected', 'a_request_out_progress', 'a_request_out_canceled', 'a_request_out_completed'];
// permission_can_show
...
// end roles 1
        ...
        getHeader($lang["requests_list_out"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['requests_list_out']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table"
                                       ...
                                       data-tj-address="dt-request-out"
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <?php
                                            $flagChecked = true;
                                            if (in_array('a_request_out_pending', $array_requests)) {
                                                ?>
                                            ...
                                            <?php }
                                            if (in_array('a_request_out_accepted', $array_requests)) {
                                                ?>
                                                <div class="form-check">
                                            ...
                                            <?php }
                                            if (in_array('a_request_out_rejected', $array_requests)) {
                                                ?>
                                                <div class="form-check">
                                            ...
                                            <?php }
                                            if (in_array('a_request_out_progress', $array_requests)) {
                                                ?>
                                                <div class="form-check">
                                            ...
                                            <?php }
                                            if (in_array('a_request_out_completed', $array_requests)) {
                                                ?>
                                                <div class="form-check">
                                            ...
                                            <?php }
                                            if (in_array('a_request_out_canceled', $array_requests)) {
                                                ?>
                                                <div class="form-check">
                ...
                <input type="hidden" id="token" name="token"
                       value="<?= $_SESSION['dt-request-out'] = "dt-request-out-44"; ?>">
            </div>
