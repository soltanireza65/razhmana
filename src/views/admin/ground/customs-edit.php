...
// end roles 1
         ...
         * Get Customs By ID
         */
        $Result = Ground::getCustomsInfoById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/customs');
        }
         ...
         * Get All Cities
         */
        $resultAllCities = Location::getAllCitiesSomeValues();
        $dataAllCities = [];
        ...
        enqueueScript('customs-edit', '/dist/js/admin/ground/customs-edit.init.js');

        getHeader($lang["customs_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["customs_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->customs_name) as $temp) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        data-mj-id="<?= $Data->customs_id; ?>"
                                        class="<?= ($Data->customs_status == "active") ? "active" : ""; ?>
                                ...
                                <button id="btnInactive"
                                        type="button"
                                        data-mj-id="<?= $Data->customs_id; ?>"
                                        class="<?= ($Data->customs_status == "inactive") ? "active" : ""; ?>
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($Data->customs_status == "active") {
                                                echo "<span class='badge badge-soft-success font-13'>" . $lang['active'] . "</span>";
                                            } elseif ($Data->customs_status == "inactive") {
                                                echo "<span class='badge badge-soft-warning font-13'>" . $lang['inactive'] . "</span>";
                                            } else {
                                                echo "<span class='badge badge-soft-danger font-13'>" . $Data->customs_status . "</span>";
                                            }
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><?= $lang["city"]; ?> :</td>
                                        <td>
                                            <?=
                                            (!empty(array_column(json_decode($Data->city_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                array_column(json_decode($Data->city_name, true), 'value', 'slug')[$_COOKIE['language']] : $lang['no_value'];
                                            ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?=
                                            (!empty(array_column(json_decode($Data->country_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                array_column(json_decode($Data->country_name, true), 'value', 'slug')[$_COOKIE['language']] : $lang['no_value'];
                                            ?>
                                        </td>
                                    </tr>
                                    <?php
                                    if (!empty($Data->customs_options)) {

                                        $temp = json_decode($Data->customs_options);
                                        $name = "";
