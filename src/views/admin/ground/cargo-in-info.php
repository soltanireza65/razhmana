...
// end roles 1
         ...
         */
        $resultCargoByID = Cargo::getCargoInByID($id);
        $dataCargoByID = [];
        ...
        if (empty($dataCargoByID)) {
            header('Location: /admin/cargo-in');
        }
         ...
         * Get All Currencies
         */
        $resultAllRequestCargoByID = Cargo::getAllRequestCargoInByID($id);
         ...
         * Get All Currencies
         */
        $resultAllExtraExpensesByCargoId = Cargo::getAllExtraExpensesByCargoInId($id);
        ...
        $getCargoAllRequest = Cargo::getCargoInAllRequest($id)->response;
        ...
        $getAdminFromAssign = Admin::getAdminFromAssign($id, 'cargo-in')->response;
        ...
        enqueueScript('cargo-in-info', '/dist/js/admin/ground/cargo-in-info.init.js');

        getHeader($lang["cargo_in_info"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="mj-admin-cargo-checklist">
                ...
                <div class="mj-admin-checklist-content">
                    <ul>
                        <?php
                        $checkList = $Settings['cargo_in_check_list'];
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="text-uppercase mt-0 mb-3 bg-light p-2" id="CargoID"
                                      ...
                                      title="' . $lang['no_address'] . '"></i>  ' : "";
                                        ?><?= $lang["cargo_in_info"]; ?></h5>

                                    <h4 class="header-title mb-3">
                                        <span class="mdi mdi-circle me-2"
                                              style="color: <?= $category_Cargo_color; ?>"></span>
                                        ...
                                        <table class="table mb-0">
                                           ...
                                           <span id="change_cargo_type" data-type="select"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                            <span id="change_cargo_weight" data-type="number"
                                                  data-bs-toggle="tooltip"
                                                  data-bs-placement="top"
                                                  title="<?= $lang['click_for_edit']; ?>"
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                    if (in_array(@json_decode(Security::decrypt($_COOKIE['INF']))->role_id, explode(',', Utils::getFileValue("settings.txt", "set_admin_cargo_in")))) {
                                        ?>
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="tab-pane active" id="basictab1">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table mb-0" style="min-height: 360px;">
                                                            <tbody>
            ...
            <input type="hidden" id="token" name="token" value="<?= Security::initCSRF('admin-cargo-in-info') ?>">
