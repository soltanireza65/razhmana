...
// end roles 1
        ...
        enqueueScript('category-car-add', '/dist/js/admin/ground/category-car-add.init.js');

        getHeader($lang["category_car_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["category_car_add"]; ?></h5>
                            <div class="row">
                                <?php
