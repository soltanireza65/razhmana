...
// end roles 1
        ...
        $resultCategoryCargoById = Cargo::getCategoryCargoById($id);
        $dataCategoryCargoById = [];
        if ($resultCategoryCargoById->status == 200 && !empty($resultCategoryCargoById->response)) {
            $dataCategoryCargoById = $resultCategoryCargoById->response[0];
        }
        if (empty($dataCategoryCargoById)) {
            header('Location: /admin/category/cargo');
        }
        ...
        enqueueScript('category-cargo-edit', '/dist/js/admin/ground/category-cargo-edit.init.js');


        getHeader($lang["category_cargo_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["category_cargo_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($dataCategoryCargoById->category_name) as $temp) {
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        ...
                                        data-id="<?= $dataCategoryCargoById->category_id; ?>"
                                        data-style="zoom-in">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["color_show"]; ?></h5>

                            <div class="mb-3">
                                <label for="assetColor" class="form-label"><?= $lang["color_show"]; ?></label>
                                <input class="form-control" id="assetColor" type="color" name="color"
                                       value="<?= $dataCategoryCargoById->category_color; ?>">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a target="_blank"
                                   href="<?= Utils::fileExist($dataCategoryCargoById->category_icon, BOX_EMPTY); ?>"
                                   class="w-100">
                                    <i class="mdi mdi-eye me-1"></i>
                                </a>
                                <?= $lang["icon"]; ?></h5>
                            <form action="/" method="post" class="dropzone" id="uploadIcon"
                                ...
                                <div class="dz-message needsclick">
                                    <img class="img-fluid rounded"
                                         src="<?= Utils::fileExist($dataCategoryCargoById->category_icon, BOX_EMPTY); ?>">
                                </div>
                            </form>
                            <small class="text-info"><?= $lang['format_support']; ?> :
                                <bdi>.image/*</bdi>
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a target="_blank"
                                   href="<?= Utils::fileExist($dataCategoryCargoById->category_image, BOX_EMPTY); ?>"
                                   class="w-100">
                                    <i class="mdi mdi-eye me-1"></i>
                                </a>
                                <?= $lang["image_default"]; ?></h5>
                            <form action="/" method="post" class="dropzone" id="uploadImage"
                                ...
                                <div class="dz-message needsclick">
                                    <img class="img-fluid rounded"
                                         src="<?= Utils::fileExist($dataCategoryCargoById->category_image, BOX_EMPTY); ?>">
                                </div>
                            </form>
                            <small class="text-info"><?= $lang['format_support']; ?> :
                                <bdi>.image/*</bdi>
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($dataCategoryCargoById->category_status == "active") {
                                                echo "<span class='badge badge-soft-success font-13'>" . $lang['active'] . "</span>";
                                            } elseif ($dataCategoryCargoById->category_status == "inactive") {
                                                echo "<span class='badge badge-soft-warning font-13'>" . $lang['inactive'] . "</span>";
                                            } else {
                                                echo "<span class='badge badge-soft-danger font-13'>" . $dataCategoryCargoById->category_status . "</span>";
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <?php
                                    if (!empty($dataCategoryCargoById->category_options)) {

                                        $temp = json_decode($dataCategoryCargoById->category_options);
                                        $name = "";
                                        ...
                                        <tr>
                                            ...
                                            <td><bdi><?= Utils::getTimeCountry('d F Y', $temp->date_create); ?></bdi></td>
                                        </tr>
                                        <?php
                                        if (!empty($temp->update)) {
                                            foreach ($temp->update as $loop) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><bdi><?= Utils::getTimeCountry('d F Y', $loop->date); ?></bdi></td>
                                                </tr>
                                                <?php
                                            }
                                        }
            ...
            <input type="hidden" id="token" name="token" value="<?= Security::initCSRF('admin-category-cargo-edit') ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'error' => $lang['error'],
                        ...
                        'error_upload_icon' => $lang['error_upload_icon'],
