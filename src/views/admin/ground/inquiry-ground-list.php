...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['inquiry_ground_title']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="freight_id,freight_name,source_city_id,dest_city_id,source_customs_id,dest_customs_id,freight_status,currency_id"
                                       data-tj-address="dt-inquiry-ground"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-inquiry-ground'] = "dt-inquiry-ground-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
