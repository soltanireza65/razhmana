...
// end roles 1
        ...
        /**
         * Get Count Customs Status
         */
        $Result = Ground::getCountCustomsFromChart();
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['customs_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/customs/add"
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="customs_id,customs_name,city_name,customs_status,customs_priority,customs_options"
                                       data-tj-address="dt-customs"
                                       class="table table-hover m-0 table-centered dt-responsive nowrap w-100">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?= $lang['name_customs']; ?></th>
                                        <th><?= $lang['city']; ?></th>
                                        <th><?= $lang['status']; ?></th>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_customs']; ?></h4>
                                </div>
                            </div>
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-customs'] = "dt-customs-44"; ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'tempp' => [
