...
// end roles 1
        ...
        enqueueScript('category-cargo-add', '/dist/js/admin/ground/category-cargo-add.init.js');

        getHeader($lang["category_cargo_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["category_cargo_add"]; ?></h5>
                            <div class="row">
                                <?php
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="assetColor" type="color" name="color" value="#01c99c">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["icon"]; ?></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["image_default"]; ?></h5>
            ...
            <input type="hidden" id="token" name="token" value="<?= Security::initCSRF('admin-category-cargo-add') ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'error' => $lang['error'],
