...
// end roles 1
         ...
         * Get All cars
         */
        $resultAllCargo = Cargo::getAllCargoIn("accepted");
        $dataAllCargo = [];
        ...
        getHeader($lang["cargoes_in_accepted"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row justify-content-between mb-3">
                <div class="col-auto">
                    <h4 class="header-title"><?= $lang["cargoes_in_accepted"]; ?></h4>
                </div>
                <div class="col-sm-6">
                    ...
                    foreach ($dataAllCargo as $dataAllCargoITEM) {
                        ...
                        <div class="col-lg-3">
                            <div class="text-center card ribbon-box">
                                <div class="card-body ">
                                    <div class="ribbon-two ribbon-two-success"><span><?= $lang['accepted']; ?></span>
                                    </div>
                                    <div class="pt-2 pb-2 ">
