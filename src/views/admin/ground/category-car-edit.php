...
// end roles 1
         ...
         */
        $resultCategoryCarById = Car::getCategoryCarById($id);
        $dataCategoryCarById = [];
        if ($resultCategoryCarById->status == 200 && !empty($resultCategoryCarById->response)) {
            $dataCategoryCarById = $resultCategoryCarById->response[0];
        }
        if (empty($dataCategoryCarById)) {
            header('Location: /admin/category/car');
        }
        ...
        enqueueScript('category-car-edit', '/dist/js/admin/ground/category-car-edit.init.js');


        getHeader($lang["category_car_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["category_car_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($dataCategoryCarById->type_name) as $temp) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        ...
                                        data-id="<?= $dataCategoryCarById->type_id; ?>"
                                        data-style="zoom-in">
                                    <?= $lang["active_submit"]; ?>
                                </button>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a target="_blank"
                                   href="<?= Utils::fileExist($dataCategoryCarById->type_icon, BOX_EMPTY); ?>"
                                   class="w-100">
                            ...
                            <form action="/" method="post" class="dropzone" id="uploadIcon"
                                ...
                                <div class="dz-message needsclick">
                                    <img class="img-fluid rounded"
                                         src="<?= Utils::fileExist($dataCategoryCarById->type_icon, BOX_EMPTY); ?>">
                                </div>
                            </form>
                            ...
                            <div class="table-responsive show" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($dataCategoryCarById->type_status == "active") {
                                                echo "<span class='badge badge-soft-success font-13'>" . $lang['active'] . "</span>";
                                            } elseif ($dataCategoryCarById->type_status == "inactive") {
                                                echo "<span class='badge badge-soft-warning font-13'>" . $lang['inactive'] . "</span>";
                                            } else {
                                                echo "<span class='badge badge-soft-danger font-13'>" . $dataCategoryCarById->type_status . "</span>";
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <?php
                                    if (!empty($dataCategoryCarById->type_options)) {

                                        $temp = json_decode($dataCategoryCarById->type_options);
                                        $name = "";
