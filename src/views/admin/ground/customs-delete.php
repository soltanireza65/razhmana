...
// end roles 1
        ...
        enqueueScript('customs-delete', '/dist/js/admin/ground/customs-delete.init.js');

        getHeader($lang['delete_customs'], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["delete_customs"]; ?></h5>
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="text-danger"><?= $lang['delete_customs_desc']; ?></p>
                                    <p class="text-muted mb-2 font-16">
                                        <span class="ms-2"><?= $lang["name_customs"]; ?> : </span>
                                        <strong id="customs_name">
                                            <?= (!empty(array_column(json_decode($data->customs_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                array_column(json_decode($data->customs_name, true), 'value', 'slug')[$_COOKIE['language']] : ""; ?>
                                        </strong>
                                    </p>
                                    ...
                                    <p class="text-muted mb-2 font-13">
                                        ...
                                        <strong>
                                            ...
                                            if ($data->customs_status == "active") {
                                                ...
                                                echo "<span class='badge badge-soft-danger font-12'>" . $data->customs_status . "</span>";
                                            }
                                            ?>
                                        </strong>
                                    </p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnDelete" type="button"
                                        data-customs-id="<?= $data->customs_id; ?>"
                                        class="btn w-sm btn-soft-danger waves-effect shadow-none waves-light"
                                        data-style="zoom-in">
                                    <?= $lang["delete"]; ?>
                                </button>
                                <a href="/admin/category/customs/edit/<?= $data->customs_id; ?>"
