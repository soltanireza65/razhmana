...
// end roles 1
        ...
        enqueueScript('category-academy-add', '/dist/js/admin/academy/category-academy-add.init.js');

        getHeader($lang['add_academy_categories'], [
            'lang' => $lang,
...
// end roles 2
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["add_academy_categories"]; ?></h5>
                            <div class="row">
                                <div class="col-sm-12 col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" id="titleCategory" class="form-control"
                                               placeholder="<?= $lang["title_category"]; ?>">
                                        <label for="titleCategory"><?= $lang["title_category"]; ?></label>
                                        <small class="form-text text-muted">
                                            <?= $lang['length_text']; ?> : <span
                                                    id="length_titleCategory" class="text-danger">0</span>
                                        </small>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        class="btn setSubmitBtn w-sm btn-soft-success waves-effect shadow-none waves-light"
                                        data-style="zoom-in">
                                    <?= $lang["active_submit"]; ?>
                                </button>
                                <button id="btnInactive"
                                        type="button"
                                        class="btn setSubmitBtn w-sm btn-soft-warning waves-effect shadow-none waves-light"
                                        data-style="zoom-in">
...
//                                        if (is_null($loop->parent_id) && empty(($loop->parent_id))) {
                                            ?>
