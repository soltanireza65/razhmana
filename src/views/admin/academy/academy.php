...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['academy_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/academy/add"
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="academy_id,academy_title,category_name,academy_language,academy_status,academy_submit_time"
                                       data-tj-address="dt-academy"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-academy'] = "dt-academy-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
