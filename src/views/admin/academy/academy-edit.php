...
// end roles 1
        ...
        enqueueScript('academy-edit', '/dist/js/admin/academy/academy-edit.init.js');

        getHeader($lang["academy_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["academy_edit"]; ?></h5>

                            <div class="row show" id="cardCollpase1">
                                <div class="col-lg-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control"
                                               value="<?= $data->academy_title; ?>"
                                               type="text"
                                               id="xTitle"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-floating">
                                        <textarea class="form-control"
                                                  ...
                                                  id="xMetaTitle"
                                                  style="height: 100px"><?php echo $data->academy_meta_title; ?></textarea>
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="<?= $lang["excerpt"]; ?>"
                                                  id="xExcerpt"
                                                  style="height: 100px"><?php echo $data->academy_excerpt; ?></textarea>
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating">
                                        <textarea class="form-control"
                                                  ...
                                                  id="xSchema"
                                                  style="height: 100px"><?php echo $data->academy_schema; ?></textarea>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnPublish"
                                        ...
                                        <?= ($data->academy_status == "published") ? "active" : ""; ?>"
                                        data-style="zoom-in">
                                ...
                                <button id="btnDraft"
                                        ...
                                        <?= ($data->academy_status == "draft") ? "active" : ""; ?>"
                                        data-style="zoom-in">
                                    <?= $lang["draft_submit"]; ?>
                                </button>
                                ...
                                <a href="/admin/academy/delete/<?= $id; ?>"
                            ...
                            <select class="form-control"
                                ...
                                if (!empty($dataCategories)) {
                                    foreach ($dataCategories as $dataCategoryITEM) {
                                        ?>
                                        <option data-tj-language="<?= $dataCategoryITEM->category_language; ?>"
                                            <?= ($data->category_id == $dataCategoryITEM->category_id) ? " selected " : ""; ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a target="_blank"
                                   href="<?= Utils::fileExist($data->academy_thumbnail, BOX_EMPTY); ?>"
                                   class="w-100">
                            ...
                            <form action="/" method="post" class="dropzone" id="uploadPost"
                                ...
                                <div class="dz-message needsclick">
                                    <img class="img-fluid rounded"
                                         src="<?= Utils::fileExist($data->academy_thumbnail, BOX_EMPTY); ?>">
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive collapse" id="cardCollpase3"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        <td colspan="2"><?= $lang["a_show_academy"]; ?> :</td>
                                        <td class="text-end"><a target="_blank"
                                                                href="<?= SITE_URL . '/academy/' . $data->academy_slug;; ?>">
                                                <?= $lang['view']; ?>
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <?php
                                    if (!empty($data->academy_options)) {

                                        $temp = json_decode($data->academy_options);
                                        $name = "";
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <bdi><?= Utils::getTimeCountry($Settings['date_format'], $data->academy_submit_time); ?></bdi>
                                            </td>
                                        </tr>
                                        <?php
