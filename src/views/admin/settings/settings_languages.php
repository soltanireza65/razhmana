...
//                if ($item000->slug_name == $pageSlug && ($item000->permission_can_edit == "yes" || $item000->permission_can_show == "yes" || $item000->permission_can_delete == "yes" || $item000->permission_can_insert == "yes")) {
        ...
        $lang_fa_IR = file_get_contents($file_fa_IR);


        $file_en_US= SITE_ROOT . "/languages/en_US.php";
        $lang_en_US = file_get_contents($file_en_US);


        $file_tr_Tr = SITE_ROOT . "/languages/tr_Tr.php";
        $lang_tr_Tr = file_get_contents($file_tr_Tr);

        $file_ru_RU = SITE_ROOT . "/languages/ru_RU.php";
        $lang_ru_RU = file_get_contents($file_ru_RU);
        ...
        enqueueScript('settings-languages', '/dist/js/admin/settings/settings-languages.init.js');

        getHeader($lang['settings_language'], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control"
                                                              ...
                                                              id="textarea_fa_IR"
                                                              style="height: 500px;direction: ltr"><?= $lang_fa_IR; ?></textarea>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control"
                                                              placeholder="<?= $lang['php_code']; ?>"
                                                              id="textarea_en_US"
                                                              style="height: 500px;direction: ltr"><?= $lang_en_US; ?></textarea>
                                                </div>
                                                <div class="col-12 mt-3">
                                                    <button data-style="zoom-in"
                                                            id="btn_en_US"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control"
                                                              placeholder="<?= $lang['php_code']; ?>"
                                                              id="textarea_tr_Tr"
                                                              style="height: 500px;direction: ltr"><?= $lang_tr_Tr; ?></textarea>
                                                </div>
                                                <div class="col-12 mt-3">
                                                    <button data-style="zoom-in"
                                                            id="btn_tr_Tr"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control"
                                                              placeholder="<?= $lang['php_code']; ?>"
                                                              id="textarea_ru_RU"
                                                              style="height: 500px;direction: ltr"><?= $lang_ru_RU; ?></textarea>
                                                </div>
                                                <div class="col-12 mt-3">
                                                    <button data-style="zoom-in"
                                                            id="btn_ru_RU"
            ...
            <!-- end row -->
            <input type="hidden" id="token" name="token" value="<?= Security::initCSRF('admin-settings-languages') ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
