...
// end roles 1
        ...
        getHeader($lang["a_list_share_massage"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_list_share_massage']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="wa_id,user_id,wa_massage,wa_status,wa_submit_time"
                                       data-tj-address="dt-share-whatsapp"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-whatsapp-massage'] = "dt-whatsapp-massage-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
