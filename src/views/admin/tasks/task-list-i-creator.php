...
// end roles 1
        ...
        getHeader($lang["a_list_task_i_creator"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_list_task_i_creator']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="task_id,task_title,task_priority,task_start_date,task_status,admin_id"
                                       data-tj-address="dt-task-i-creator"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-task-for-me'] = "dt-task-for-me-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
