...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_list_task']; ?></h4>
                                </div>
                                <div class="col-auto">
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-task-all'] = "dt-task-all-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
