...
// end roles 1
        ...
        enqueueScript('category-post-add', '/dist/js/admin/post/category-post-add.init.js');

        getHeader($lang['add_post_categories'], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["add_post_categories"]; ?></h5>
                            <div class="row">
