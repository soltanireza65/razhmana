...
// end roles 1
        ...
        getHeader($lang['post_categories'], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['post_categories']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/post/add"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if (!empty($dataLanguages)) {
                                                        foreach ($dataLanguages as $dataLanguagesITEM) {
                                                            if ($dataLanguagesITEM->slug == $dataCategoriesTEMP->category_language) {
                                                ...
                                                <td>
                                                    <a target="_self"
                                                       ...
                                                       title="<?= $lang['edit']; ?>"
                                                       href="/admin/category/post/edit/<?= $dataCategoriesTEMP->category_id; ?>"
                                                       class="action-icon">
                                                    ...
                                                    <a target="_self"
                                                       ...
                                                       data-bs-placement="top"
                                                       title="<?= $lang['delete']; ?>"
                                                       href="/admin/category/post/delete/<?= $dataCategoriesTEMP->category_id; ?>"
                                                       class="action-icon">
