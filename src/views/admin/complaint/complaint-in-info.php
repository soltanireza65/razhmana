...
// end roles 1
         ...
         */
        $Result = Complaint::getComplaintInByID($id);
        $Data = [];
         ...
         */
        $resultCargoByID = Cargo::getCargoInByID($Data->cargo_id);
        $dataCargoByID = [];
        ...
        enqueueScript('complaint-in-info', '/dist/js/admin/complaint/complaint-in-info.init.js');
        ...
        if ($flagSlug) {
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a href="/admin/cargo-in/<?= $Data->cargo_id; ?>"
                                   target="_self">
                                    <i class="mdi mdi-account-circle-outline"
                                       data-bs-toggle="tooltip"
                                       data-bs-placement="top"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if(isset($dataCargoByID->$cargoName)){
                                                        echo $dataCargoByID->$cargoName;
                                                    }else{
                                                        if(isset($dataCargoByID->cargo_name_fa_IR)){
                                                            echo $dataCargoByID->cargo_name_fa_IR;
                                                        }elseif(isset($dataCargoByID->cargo_name_en_US)){
                                                            echo $dataCargoByID->cargo_name_tr_Tr;
                                                        }elseif(isset($dataCargoByID->cargo_name_tr_Tr)){
                                                            echo $dataCargoByID->cargo_name_en_US;
                                                        }elseif(isset($dataCargoByID->cargo_name_ru_RU)){
                                                            echo $dataCargoByID->cargo_name_ru_RU;
                                                        }
                                                    }
                                                    ?>
                                                </td>
                            ...
                            <div class="table-responsive show"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <bdi>
                                                <?= Utils::getTimeCountry('d F Y | H:i', $Data->complaint_date); ?>
                                            </bdi>
                                        </td>
                                    </tr>
                                    <?php
                                    ...
                                    if (!empty($Data->complaint_options)) {
                                        ...
                                        if (isset($temp->closed_date)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <bdi>
                                                        <?= Utils::getTimeCountry($Settings['data_time_format'], $temp->closed_date); ?>
                                                    </bdi>
                                                </td>
                                            </tr>
                                            <?php
            ...
            <input type="hidden" id="token" name="token" value="<?= Security::initCSRF('admin-complaint-in-info') ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'error' => $lang['error'],
