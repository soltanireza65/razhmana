...
// end roles 1
        ...
        getHeader($lang["complaints_pending"], [
            'lang' => $lang,
            ...
            <div class="row" id="RowDiv">
                ...
                if (!empty($Data)) {
                    foreach ($Data as $DataITEM) {
                        ...
                        ?>
                        <div class="col-md-4">
                            <div class="card mb-0 mt-3 border border-danger">
                                <div class="card-body">
                                    <span class="badge badge-soft-danger float-end"><?= $lang['pending_answer']; ?></span>
                                    <h5 class="mt-0"><a href="javascript: void(0);" class="text-danger">
                                            <?php
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">
                                           <span class="text-muted">
                                            ...
                                            <?= Security::decrypt($Complainer->user_firstname) . " " . Security::decrypt($Complainer->user_lastname); ?>
                                        </li>
                                        <li class="list-group-item">
                                               <span class="text-muted">
                                            <?= $lang['accused']; ?> :
                                            </span>
                                            <?= Security::decrypt($Accused->user_firstname) . " " . Security::decrypt($Accused->user_lastname); ?>
                                        </li>
                                    </ul>
