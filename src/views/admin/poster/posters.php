...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_poster_list']; ?></h4>
                                </div>
                            </div>
                            <div class="table-responsive">
                                ...
                                <table id="orders-table"
                                       data-page-length='10'
                                       data-order='[[ 0, "desc" ]]'
                                       data-tj-col="poster_id,user_firstname,user_lastname,poster_type,poster_submit_date,poster_status,poster_expire"
                                       data-tj-address="dt-posters"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-posters'] = "dt-posters-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
