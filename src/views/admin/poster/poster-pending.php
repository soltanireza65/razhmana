...
// end roles 1
        ...
        /**
         * Get All Poster pending Status
         */
        $Result = Poster::getAllPostersByStatus('pending');
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response;
        }

        getHeader($lang["a_poster_list_pending"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row justify-content-between mb-3">
                <div class="col-auto">
                    <h4 class="header-title"><?= $lang["a_poster_list_pending"]; ?></h4>
                </div>
                <div class="col-sm-6">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-4">
                                        <p class="mb-1 mt-3 mt-sm-0">
                                            ...
                                            <bdi><?= Utils::getTimeCountry($Settings['date_format'], $DataITEM->poster_submit_date); ?></bdi>
                                        </p>
                                        <p class="mb-0">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="text-center mt-3 mt-sm-0">
                                            <?= "<div class='badge badge-soft-warning text-warning p-1 font-14'>" . $lang['a_pending_poster'] . "</div>"; ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="text-sm-end">
                                            <a href="/admin/poster/info/<?= $DataITEM->poster_id; ?>"
                                               class="action-icon">
                                                <i class="mdi mdi-eye"
                                                   data-bs-toggle="tooltip"
                                                   data-bs-placement="top"
