...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_request_expert']; ?></h4>
                                </div>
                            </div>
                            <div class="table-responsive">
                                ...
                                <table id="orders-table"
                                       data-page-length='10'
                                       data-order='[[ 0, "desc" ]]'
                                       data-tj-col="pe_id,user_firstname,user_lastname,pe_status,pe_submit_date,pe_address"
                                       data-tj-address="dt-poster-expert"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-poster-expert'] = "dt-poster-expert-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
