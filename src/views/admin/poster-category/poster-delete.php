...
// end roles 1
        ...
        /**
         * Get All Category Reason Deleted Poster
         */
        $Result = PosterC::getAllCategoryReasonDeletedPosterFromTable();
        $Data = [];
        ...
        getHeader($lang["a_poster_reason_delete_c"], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_poster_reason_delete_c']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/poster-delete/add"
                                    ...
                                    if (!empty($Data)) {
                                        ...
                                        foreach ($Data as $Loop) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?= $Loop->category_priority; ?>
                                                </td>
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/poster-delete/edit/<?= $Loop->category_id; ?>"
