<?php
$pageSlug = "a_poster_reason_delete_c";
// permission_can_edit
...
// end roles 1
        ...
        /**
         * Get Category Poster Delete By ID
         */
        $Result = PosterC::getCategoryReasonDeletedPosterById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/poster-delete');
        }
        ...
        enqueueScript('poster-delete-edit', '/dist/js/admin/poster-category/poster-delete-edit.init.js');

        getHeader($lang["a_poster_reason_delete_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["a_poster_reason_delete_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->category_name) as $temp) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        class="<?= ($Data->category_status == "active") ? "active" : ""; ?>
