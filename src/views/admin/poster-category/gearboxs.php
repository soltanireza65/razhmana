...
// end roles 1
         ...
         * Get All Gearboxs
         */
        $result = PosterC::getAllGearboxFromTabel();
        $data = [];
        ...
        getHeader($lang["a_list_gearboxs"], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_list_gearboxs']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/gearbox/add"
                                        ...
                                        foreach ($data as $loop) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-user text-start">
                                                    <img src="<?= Utils::fileExist($loop->gearbox_image, BOX_EMPTY); ?>"
                                                         alt=" <?= $loop->gearbox_id; ?>"
                                                         class="me-2 rounded-circle">
                                                    <a href="/admin/category/gearbox/edit/<?= $loop->gearbox_priority; ?>"
                                                       class="text-body fw-normal">
                                                        <?= (!empty(array_column(json_decode($loop->gearbox_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                            array_column(json_decode($loop->gearbox_name, true), 'value', 'slug')[$_COOKIE['language']] : $loop->gearbox_id; ?>
                                                    </a>
                                                </td>
                                                <td>
                                                    <?= $loop->gearbox_priority; ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    if ($loop->gearbox_status == "active") {
                                                        ...
                                                        $status_active += 1;
                                                    } elseif ($loop->gearbox_status == "inactive") {
                                                        echo "<span class='badge badge-soft-warning font-12'>" . $lang['inactive'] . "</span>";
                                                        $status_inactive += 1;
                                                    }  else {
                                                        echo "<span class='badge badge-soft-pink font-12'>" . $loop->gearbox_status . "</span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/gearbox/edit/<?= $loop->gearbox_id; ?>"
