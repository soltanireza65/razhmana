...
// end roles 1
         ...
         */
        $result = PosterC::getBrandById($id);
        $data = [];
        if ($result->status == 200 && !empty($result->response)) {
            $data = $result->response[0];
        }
        if (empty($data)) {
            header('Location: /admin/category/brand');
        }
        ...
        enqueueScript('brand-edit', '/dist/js/admin/poster-category/brand-edit.init.js');


        getHeader($lang["a_brand_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($data->brand_name) as $temp) {
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($data->brand_creator == "admin") {
                                                echo $lang['admin'];
                                            } elseif ($data->brand_creator == "user") {
                                                echo $lang['user'];
                                            } else {
                                                echo $data->brand_creator;
                                            }
                                            ?>
                                        </td>
                                    </tr>
                                    ...
                                    <?php
                                    if (!empty($data->brand_options)) {

                                        $temp = json_decode($data->brand_options);
                                        $name = "";
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        data-tj-id="<?= $id; ?>"
                                        data-tj-image="<?= (!empty($data->brand_image)) ? "full" : "empty"; ?>"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["a_type_2_selected"]; ?></h5>
                            <select class="form-control"
                                    id="xType"
                                    data-toggle="select2"
                                    data-width="100%"
                                    data-placeholder="<?= $lang['a_type_2_selected']; ?>">
                                <option <?= ($data->brand_type == "truck") ? "selected" : null; ?>
                                        value="truck"><?= $lang['a_truck']; ?></option>
                                <option <?= ($data->brand_type == "trailer") ? "selected" : null; ?>
                                        value="trailer"><?= $lang['a_trailer']; ?></option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a target="_self"
                                   ...
                                   href="<?= Utils::fileExist($data->brand_image, BOX_EMPTY); ?>"
                                   class="w-100">
                            ...
                            <form action="/" method="post" class="dropzone" id="uploadImage"
                                ...
                                <div class="dz-message needsclick">
                                    <img class="img-fluid rounded"
                                         src="<?= Utils::fileExist($data->brand_image, BOX_EMPTY); ?>">
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        ...
                        'a_type_2_no_select' => $lang['a_type_2_no_select'],
