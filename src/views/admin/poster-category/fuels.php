...
// end roles 1
         ...
         * Get All Fuel
         */
        $result = PosterC::getAllFuelFromTabel();
        $data = [];
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_list_fuels']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/fuel/add"
                                        ...
                                        foreach ($data as $loop) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-user text-start">
                                                    <img src="<?= Utils::fileExist($loop->fuel_image, BOX_EMPTY); ?>"
                                                         alt=" <?= $loop->fuel_id; ?>"
                                                         class="me-2 rounded-circle">
                                                    <a href="/admin/category/fuel/edit/<?= $loop->fuel_priority; ?>"
                                                       class="text-body fw-normal">
                                                        <?= (!empty(array_column(json_decode($loop->fuel_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                            array_column(json_decode($loop->fuel_name, true), 'value', 'slug')[$_COOKIE['language']] : $loop->fuel_id; ?>
                                                    </a>
                                                </td>
                                                <td>
                                                    <?= $loop->fuel_priority; ?>
                                                ...
                                                <td>
                                                    ...
                                                    if ($loop->fuel_status == "active") {
                                                        ...
                                                        $status_active += 1;
                                                    } elseif ($loop->fuel_status == "inactive") {
                                                        echo "<span class='badge badge-soft-warning font-12'>" . $lang['inactive'] . "</span>";
                                                        $status_inactive += 1;
                                                    } elseif ($loop->fuel_status == "user") {
                                                        echo "<span class='badge badge-soft-info font-12'>" . $lang['a_user_creator'] . "</span>";
                                                        $status_user += 1;
                                                    } else {
                                                        echo "<span class='badge badge-soft-pink font-12'>" . $loop->fuel_status . "</span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/fuel/edit/<?= $loop->fuel_id; ?>"
