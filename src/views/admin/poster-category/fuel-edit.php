...
// end roles 1
         ...
         * get fuel Info By Id
         */
        $result = PosterC::getFuelById($id);
        $data = [];
        if ($result->status == 200 && !empty($result->response)) {
            $data = $result->response[0];
        }
        if (empty($data)) {
            header('Location: /admin/category/fuel');
        }
        ...
        enqueueScript('fuel-edit', '/dist/js/admin/poster-category/fuel-edit.init.js');


        getHeader($lang["a_fuel_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["a_fuel_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($data->fuel_name) as $temp) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <?php
                                    if (!empty($data->fuel_options)) {

                                        $temp = json_decode($data->fuel_options);
                                        $name = "";
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        data-tj-id="<?= $id; ?>"
                                        data-tj-image="<?= (!empty($data->fuel_image)) ? "full" : "empty"; ?>"
                        ...
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a target="_blank"
                                   ...
                                   href="<?= Utils::fileExist($data->fuel_image, BOX_EMPTY); ?>"
                                   class="w-100">
                            ...
                            <form action="/" method="post" class="dropzone" id="uploadImage"
                                ...
                                <div class="dz-message needsclick">
                                    <img class="img-fluid rounded"
                                         src="<?= Utils::fileExist($data->fuel_image, BOX_EMPTY); ?>">
                                </div>
                            </form>
                        </div>
                    </div>
