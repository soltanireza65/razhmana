...
// end roles 1
        ...
        $result = PosterC::getReportById($id);
        $data = [];
        if ($result->status == 200 && !empty($result->response)) {
            $data = $result->response[0];
        }
        if (empty($data)) {
            header('Location: /admin/category/report');
        }
        ...
        enqueueScript('report-edit', '/dist/js/admin/poster-category/report-edit.init.js');


        getHeader($lang["a_report_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["a_report_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($data->report_title) as $temp) {
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($data->report_creator == "admin") {
                                                echo $lang['admin'];
                                            } elseif ($data->report_creator == "user") {
                                                echo $lang['user'];
                                            } else {
                                                echo $data->report_creator;
                                            }
                                            ?>
                                        </td>
                                    </tr>
                                    ...
                                    <?php
                                    if (!empty($data->report_options)) {

                                        $temp = json_decode($data->report_options);
                                        $name = "";
