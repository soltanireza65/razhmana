...
// end roles 1
         ...
         * Get All property
         */
        $result = PosterC::getAllPropertyFromTabel();
        $data = [];
        ...
        getHeader($lang["a_list_property"], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['a_list_property']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/property/add"
                                    ...
                                    if (!empty($data)) {
                                        ...
                                        foreach ($data as $loop) {
                                            ...
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                <td>
                                                    <?= (!empty(array_column(json_decode($loop->property_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                        array_column(json_decode($loop->property_name, true), 'value', 'slug')[$_COOKIE['language']] : $loop->property_id; ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    if ($loop->property_type == "truck") {
                                                        echo "<span class='badge badge-outline-info font-12'>" . $lang['a_truck_property'] . "</span>";
                                                    } elseif ($loop->property_type == "trailer") {
                                                        echo "<span class='badge badge-outline-primary font-12'>" . $lang['a_trailer_property'] . "</span>";
                                                    } else {
                                                        echo "<span class='badge badge-outline-pink font-12'>" . $loop->property_type . "</span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <?= $loop->property_priority; ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    if ($loop->property_status == "active") {
                                                        echo "<span class='badge badge-soft-success font-12'>" . $lang['active'] . "</span>";
                                                        $status_active += 1;
                                                    } elseif ($loop->property_status == "inactive") {
                                                        echo "<span class='badge badge-soft-warning font-12'>" . $lang['inactive'] . "</span>";
                                                        $status_inactive += 1;
                                                    } else {
                                                        echo "<span class='badge badge-soft-pink font-12'>" . $loop->property_status . "</span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/property/edit/<?= $loop->property_id; ?>"
