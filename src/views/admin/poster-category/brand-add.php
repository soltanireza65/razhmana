...
// end roles 1
        ...
        enqueueScript('brand-add', '/dist/js/admin/poster-category/brand-add.init.js');


        getHeader($lang["a_brand_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["a_brand_add"]; ?></h5>
                            <div class="row">
                                <?php
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <select class="form-control"
                                ...
                                <option value=""></option>
                                <option value="truck"><?= $lang['a_truck']; ?></option>
                                <option value="trailer"><?= $lang['a_trailer']; ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["a_image"]; ?></h5>
