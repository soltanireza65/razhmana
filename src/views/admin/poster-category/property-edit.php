...
// end roles 1
         ...
         */
        $result = PosterC::getPropertyById($id);
        $data = [];
        if ($result->status == 200 && !empty($result->response)) {
            $data = $result->response[0];
        }
        if (empty($data)) {
            header('Location: /admin/category/property');
        }
        ...
        enqueueScript('property-edit', '/dist/js/admin/poster-category/property-edit.init.js');


        getHeader($lang["a_property_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["a_property_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($data->property_name) as $temp) {
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            } elseif ($data->property_status == "inactive") {
                                                echo "<span class='badge badge-soft-warning font-13'>" . $lang['inactive'] . "</span>";
                                            } else {
                                                echo "<span class='badge badge-soft-danger font-13'>" . $data->property_status . "</span>";
                                            }
                                            ?>
                                        </td>
                                    </tr>
                                    ...
                                    <?php
                                    if (!empty($data->property_options)) {

                                        $temp = json_decode($data->property_options);
                                        $name = "";
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        data-tj-id="<?= $id; ?>"
                                        data-tj-image="<?= (!empty($data->property_image)) ? "full" : "empty"; ?>"
                                ...
                                <a href="/admin/category/property"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <select class="form-control"
                                    ...
                                    data-toggle="select2"
                                    data-width="100%">
                                <option value="truck" <?= ($data->property_type == "truck") ? "selected" : ""; ?>><?= $lang['a_truck_property']; ?></option>
                                <option value="trailer" <?= ($data->property_type == "trailer") ? "selected" : ""; ?>><?= $lang['a_trailer_property']; ?></option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">
                                <a target="_blank"
                                   ...
                                   href="<?= Utils::fileExist($data->property_image, BOX_EMPTY); ?>"
                                   class="w-100">
                            ...
                            <form action="/" method="post" class="dropzone" id="uploadImage"
                                ...
                                <div class="dz-message needsclick">
                                    <img class="img-fluid rounded"
                                         src="<?= Utils::fileExist($data->property_image, BOX_EMPTY); ?>">
                                </div>
                            </form>
                        </div>
                    </div>
