...
// end roles 1
        ...
        /**
         * Get All Category Ship Cargo
         */
        $Result = Ship::getAllCategoryShipCargo();
        $Data = [];
        ...
        getHeader($lang["ship_cargo_list"], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['ship_cargo_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/ship-cargo/add"
                                    ...
                                    if (!empty($Data)) {
                                        ...
                                        foreach ($Data as $Loop) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/ship-cargo/edit/<?= $Loop->category_id; ?>"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_ship_cargo']; ?></h4>
                                </div>
                            </div>
