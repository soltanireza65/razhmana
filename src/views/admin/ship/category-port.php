...
// end roles 1
        ...
        /**
         * Get Count ports Status
         */
        $Result = Ship::getCountPortsFromChart();
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['ports_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/port/add"
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="port_id,port_name,city_name,port_status,port_priority,port_options"
                                       data-tj-address="dt-ports"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_ports']; ?></h4>
                                </div>
                            </div>
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-ports'] = "dt-ports-44"; ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'tempp' => [
