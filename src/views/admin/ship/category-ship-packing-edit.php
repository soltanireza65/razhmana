...
// end roles 1
         ...
         * Get packing By ID
         */
        $Result = Ship::getCategoryShipPackingById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/ship-packing');
        }
        ...
        enqueueScript('ship-packing-edit', '/dist/js/admin/ship/ship-packing-edit.init.js');

        getHader($lang["ship_packing_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["ship_packing_edit"]; ?></h5>
                            <div class="row">
                                <?php
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                ...
                                <a href="/admin/category/ship-packing"
