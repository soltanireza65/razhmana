...
// end roles 1
         ...
         * Get container By ID
         */
        $Result = Ship::getContainerById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/container');
        }
        ...
        enqueueScript('container-edit', '/dist/js/admin/ship/container-edit.init.js');

        getHeader($lang["container_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["container_edit"]; ?></h5>
                            <div class="row">
                                <?php
