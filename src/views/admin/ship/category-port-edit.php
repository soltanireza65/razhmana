...
// end roles 1
         ...
         * Get Port By ID
         */
        $Result = Ship::getPortInfoById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/port');
        }
         ...
         * Get All Cities
         */
        $resultAllCities = Location::getAllCitiesSomeValues('ship');
        $dataAllCities = [];
        ...
        enqueueScript('port-edit', '/dist/js/admin/ship/port-edit.init.js');

        getHeader($lang["port_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["port_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->port_name) as $temp) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <?php
                                    if (!empty($Data->port_options)) {

                                        $temp = json_decode($Data->port_options);
                                        $name = "";
