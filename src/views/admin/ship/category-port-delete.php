...
// end roles 1
        ...
        enqueueScript('port-delete', '/dist/js/admin/ship/port-delete.init.js');

        getHeader($lang['delete_port'], [
            'lang' => $lang,
...
// end roles 2
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["delete_port"]; ?></h5>
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="text-danger"><?= $lang['delete_port_desc']; ?></p>
                                    <p class="text-muted mb-2 font-16">
                                        <span class="ms-2"><?= $lang["name_port"]; ?> : </span>
                                        <strong id="port_name">
                                            <?= (!empty(array_column(json_decode($data->port_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                array_column(json_decode($data->port_name, true), 'value', 'slug')[$_COOKIE['language']] : ""; ?>
                                        </strong>
                                    </p>
                                    ...
                                    <p class="text-muted mb-2 font-13">
                                        ...
                                        <strong>
                                            ...
                                            if ($data->port_status == "active") {
                                                ...
                                                echo "<span class='badge badge-soft-danger font-12'>" . $data->port_status . "</span>";
                                            }
                                            ?>
                                        </strong>
                                    </p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnDelete" type="button"
                                        data-port-id="<?= $data->port_id; ?>"
                                        class="btn w-sm btn-soft-danger waves-effect shadow-none waves-light"
                                        data-style="zoom-in">
                                    <?= $lang["delete"]; ?>
                                </button>
                                <a href="/admin/category/port/edit/<?= $data->port_id; ?>"
