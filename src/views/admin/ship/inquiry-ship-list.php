...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['inquiry_ship_title']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="freight_id,freight_name,source_city_id,dest_city_id,source_port_id,dest_port_id,freight_status,currency_id"
                                       data-tj-address="dt-inquiry-ship"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-inquiry-ship'] = "dt-inquiry-ship-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
