...
// end roles 1
        ...
        enqueueScript('ship-packing-add', '/dist/js/admin/ship/ship-packing-add.init.js');

        getHeader($lang["ship_packing_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["ship_packing_add"]; ?></h5>
                            <div class="row">
                                <?php
