...
// end roles 1
         ...
         */
        $result = MiniCargo::getInquiryInfoById($id);
        $data = [];
        if ($result->status == 200) {
            $data = $result->response[0];
        }
        if (empty($data)) {
            header('Location: /admin/inquiry/minicargo');
        }
        ...
        $resultValues = MiniCargo::getAllFreightMiniCargoValuesById($id)->response;
        ...
        enqueueScript('inquiry-minicargo-info', '/dist/js/admin/minicargo/inquiry-minicargo-info.init.js');


        getHeader($lang["a_inquiry_minicargo_title"], [
            'lang' => $lang,
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <td><?= $lang["location_cargo_origin"]; ?> :</td>
                                        <td>
                                             <?= Location::getCountryByCityId($data->source_city_id)->CountryName ?>
                                            -
                                            <?= Location::getCityNameById($data->source_city_id)->response ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><?= $lang["location_cargo_destination"]; ?> :</td>
                                        <td>
                                         <?= Location::getCountryByCityId($data->dest_city_id)->CountryName ?>
                                            -
                                            <?= Location::getCityNameById($data->dest_city_id)->response ?>
                                        </td>
                                    </tr>
