...
// end roles 1
         ...
         * Get All Cities
         */
        $resultAllCities = Location::getAllCitiesSomeValues('railroad');
        $dataAllCities = [];
        ...
        enqueueScript('railroad-edit', '/dist/js/admin/railroad/railroad-edit.init.js');

        getHeader($lang["railroad_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["railroad_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->railroad_name) as $temp) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive"
                                        type="button"
                                        class="<?= ($Data->railroad_status == "active") ? "active" : ""; ?>
                                         setSubmitBtn btn w-sm btn-soft-success waves-effect shadow-none waves-light"
                                        data-id="<?= $Data->railroad_id; ?>"
                                        data-style="zoom-in">
                                    <?= $lang["active_submit"]; ?>
                                </button>
                                <button id="btnInactive" type="button"
                                        class="<?= ($Data->railroad_status == "inactive") ? "active" : ""; ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($Data->railroad_status == "active") {
                                                ...
                                                echo "<span class='badge badge-soft-danger font-13'>" . $Data->railroad_status . "</span>";
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <?php
                                    if (!empty($Data->railroad_options)) {

                                        $temp = json_decode($Data->railroad_options);
                                        $name = "";
