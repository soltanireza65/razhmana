...
// end roles 1
        ...
        /**
         * Get All Category Railroad Cargo
         */
        $Result = Railroad::getAllCategoryRailroadCargoFromTable();
        $Data = [];
        ...
        getHeader($lang["railroad_cargo_list"], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['railroad_cargo_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/railroad-cargo/add"
                                    ...
                                    if (!empty($Data)) {
                                        ...
                                        foreach ($Data as $Loop) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/railroad-cargo/edit/<?= $Loop->category_id; ?>"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_railroad_cargo']; ?></h4>
                                </div>
                            </div>
