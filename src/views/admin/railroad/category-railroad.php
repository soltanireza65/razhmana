...
// end roles 1
        ...
        /**
         * Get Count Railroad Status
         */
        $Result = Railroad::getCountRailroadFromChart();
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['railroad_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/railroad/add"
                                           data-tj-col="railroad_id,railroad_name,city_name,railroad_status,railroad_priority,railroad_options"
                                           data-tj-address="dt-railroad"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_railroad']; ?></h4>
                                </div>
                            </div>
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-railroad'] = "dt-railroad-44"; ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'tempp' => [
