...
// end roles 1
         ...
         * Get packing By ID
         */
        $Result = Railroad::getCategoryRailroadPackingById($id);
        $Data = [];
        if ($Result->status == 200 && !empty($Result->response)) {
            $Data = $Result->response[0];
        }
        if (empty($Data)) {
            header('Location: /admin/category/railroad-packing');
        }
        ...
        enqueueScript('railroad-packing-edit', '/dist/js/admin/railroad/railroad-packing-edit.init.js');

        getHeader($lang["railroad_packing_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["railroad_packing_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->packing_name) as $temp) {
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($Data->packing_status == "active") {
                                                echo "<span class='badge badge-soft-success font-13'>" . $lang['active'] . "</span>";
                                            } elseif ($Data->packing_status == "inactive") {
                                                echo "<span class='badge badge-soft-warning font-13'>" . $lang['inactive'] . "</span>";
                                            } else {
                                                echo "<span class='badge badge-soft-danger font-13'>" . $Data->packing_status . "</span>";
                                            }
                                            ?>
                                        </td>
                                    ...
                                    if (!empty($Data->packing_options)) {
                                        ...
                                        $temp = json_decode($Data->packing_options);
                                        $name = "";
