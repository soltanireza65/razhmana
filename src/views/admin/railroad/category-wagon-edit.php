...
// end roles 1
         ...
         * Get wagon By ID
         */
        $Result = Railroad::getWagonById($id);
        $Data = [];
        ...
        enqueueScript('wagon-edit', '/dist/js/admin/railroad/wagon-edit.init.js');

        getHeader($lang["wagon_edit"], [
            'lang' => $lang,
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["wagon_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($Data->wagon_name) as $temp) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive collapse" style="max-height: 176px;overflow: auto;"
                                ...
                                <table class="table mb-0 table-sm">
                                    ...
                                    <?php
                                    if (!empty($Data->wagon_options)) {

                                        $temp = json_decode($Data->wagon_options);
                                        $name = "";
