...
// end roles 1
        ...
        /**
         * Get All Inquiry Railroad process Status
         */
        $Result = Railroad::getAllInquiryRailroadByStatus('process');
        $Data = [];
        ...
        if ($flagSlug) {
            ...
            <div class="row justify-content-between mb-3">
                <div class="col-auto">
                    <h4 class="header-title"><?= $lang["inquiry_railroad_title"]; ?></h4>
                </div>
                <div class="col-sm-6">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="text-center mt-3 mt-sm-0">
                                            <?= "<div class='badge badge-soft-info text-info p-1 font-14'>" . $lang['a_freight_process'] . "</div>"; ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="text-sm-end">
                                            <a href="/admin/inquiry/railroad/<?= $DataITEM->freight_id; ?>"
                                               class="action-icon">
                                                <i class="mdi mdi-eye"
                                                   data-bs-toggle="tooltip"
                                                   data-bs-placement="top"
