...
// end roles 1
        ...
        /**
         * Get All Category railroad packing
         */
        $Result = Railroad::getAllCategoryRailroadPackingFromTable();
        $Data = [];
        ...
        getHeader($lang["railroad_packing_list"], [
            'lang' => $lang,
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['railroad_packing_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/category/railroad-packing/add"
                                    ...
                                    if (!empty($Data)) {
                                        ...
                                        foreach ($Data as $Loop) {
                                            ...
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                <td>
                                                    <?= (!empty(array_column(json_decode($Loop->packing_name, true), 'value', 'slug')[$_COOKIE['language']])) ?
                                                        array_column(json_decode($Loop->packing_name, true), 'value', 'slug')[$_COOKIE['language']] : ""; ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    if ($Loop->packing_status == "active") {
                                                        echo "<span class='badge badge-soft-success font-12'>" . $lang['active'] . "</span>";
                                                        $status_active += 1;
                                                    } elseif ($Loop->packing_status == "inactive") {
                                                        echo "<span class='badge badge-soft-warning font-12'>" . $lang['inactive'] . "</span>";
                                                        $status_inactive += 1;
                                                    } else {
                                                        echo "<span class='badge badge-soft-danger font-12'>" . $Loop->packing_status . "</span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <a target="_self"
                                                       href="/admin/category/railroad-packing/edit/<?= $Loop->packing_id; ?>"
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['chart_railroad_packing']; ?></h4>
                                </div>
                            </div>
