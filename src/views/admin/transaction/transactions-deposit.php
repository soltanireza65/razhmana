...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['list_deposit']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table"
                                       ...
                                       data-tj-address="dt-transactions-deposit"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-transactions-deposit'] = "dt-transactions-deposit-44"; ?>">
