...
// end roles 1
        ...
        getHeader($lang["list_transactions"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['list_transactions']; ?></h4>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table id="orders-table"
                                       data-page-length='25'
                                       data-order='[[ 0, "desc" ]]'
                                       data-tj-col="transaction_id,user_firstname,user_lastname,transaction_authority,transaction_tracking_code,transaction_status,transaction_date,transaction_type,transaction_amount,card_id"
                                       data-tj-address="dt-transactions"
                                    ...
                                    <tr>
                                        ...
                                        <th><input class="form-control" id="authority" type="text" data-tj-col="3"
                                                   placeholder="<?= $lang['search']; ?>"/></th>
                                        <th><input class="form-control" id="tacking-code" type="text" data-tj-col="3"
                                                   placeholder="<?= $lang['search']; ?>"/></th>
                                        <th><?= $lang['status']; ?></th>
                                        <th><?= $lang['transaction_list_date']; ?></th>
                                        <th><?= $lang['transaction_type']; ?></th>
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-transactions'] = "dt-transactions-44"; ?>">
