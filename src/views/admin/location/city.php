...
// end roles 1
        ...
        if ($flagSlug) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between mb-3">
                                <div class="col-auto">
                                    <h4 class="page-title"><?= $lang['cities_list']; ?></h4>
                                </div>
                                <div class="col-auto">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        <a target="_self" href="/admin/city/add"
                            ...
                            <div class="table-responsive">
                                <table id="orders-table" data-page-length='10' data-order='[[ 0, "desc" ]]'
                                       data-tj-col="city_id,city_name,country_name,city_lat,city_long,city_priority,city_options"
                                       data-tj-address="dt-city"
            ...
            <input type="hidden" id="token" name="token"
                   value="<?= $_SESSION['dt-city'] = "dt-city-44"; ?>">
            <?php
            // start roles 3
        } else {
            getPermissionsBlock();
