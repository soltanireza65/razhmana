...
// end roles 1
        ...
        enqueueScript('department-add', '/dist/js/admin/ticket/department-add.init.js');

        getHeader($lang["department_add"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["department_add"]; ?></h5>
                            <div class="row">
                                <?php
            ...
            <input type="hidden" id="token" name="token" value="<?= Security::initCSRF('admin-department-add') ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'error' => $lang['error'],
