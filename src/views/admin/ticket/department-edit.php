...
// end roles 1
         ...
         */
        $resultvDepartmentById = ATicket::getDepartmentById($id);
        $datagetDepartmentById = [];
        if ($resultvDepartmentById->status == 200 && !empty($resultvDepartmentById->response)) {
            $datagetDepartmentById = $resultvDepartmentById->response[0];
        }
        if (empty($datagetDepartmentById)) {
        ...
        enqueueScript('department-edit', '/dist/js/admin/ticket/department-edit.init.js');

        getHeader($lang["department_edit"], [
            'lang' => $lang,
        ...
        if ($flagSlug) {
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["department_edit"]; ?></h5>
                            <div class="row">
                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control titleCategory"
                                                    ...
                                                    <?php
                                                    foreach (json_decode($datagetDepartmentById->department_name) as $temp) {
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center progress-demo">
                                <button id="btnActive" type="button"
                                        class="<?= ($datagetDepartmentById->department_status == "active") ? "active":""; ?> setSubmitBtn btn w-sm btn-soft-success waves-effect shadow-none waves-light"
                                        data-id="<?= $datagetDepartmentById->department_id; ?>"
                                        data-style="zoom-in">
                                    <?= $lang["active_submit"]; ?>
                                </button>
                                <button id="btnInactive" type="button"
                                        class="<?=($datagetDepartmentById->department_status == "inactive") ? "active":""; ?> setSubmitBtn btn w-sm btn-soft-warning waves-effect shadow-none waves-light"
                                        data-id="<?= $datagetDepartmentById->department_id; ?>"
                                        data-style="zoom-in">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2"><?= $lang["category_type"]; ?></h5>
                            <select class="form-control" id="typeCategries" data-toggle="select2"
                                    data-width="100%">
                                <option <?php if ($datagetDepartmentById->department_type == "driver") {
                                    echo "selected";
                                } ?> value="driver"><?= $lang['driver']; ?></option>
                                <option <?php if ($datagetDepartmentById->department_type == "businessman") {
                                    echo "selected";
                                } ?> value="businessman"><?= $lang['businessman']; ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive show" style="max-height: 176px;overflow: auto;" id="cardCollpase1">
                                <table class="table mb-0 table-sm">
                                    <tbody>
                                    <tr>
                                        <td colspan="2"><?= $lang["status"]; ?> :</td>
                                        <td><?php
                                            if ($datagetDepartmentById->department_status == "active") {
                                                echo "<span class='badge badge-soft-success font-13'>".$lang['active']."</span>";
                                            } elseif ($datagetDepartmentById->department_status == "inactive") {
                                                echo "<span class='badge badge-soft-warning font-13'>".$lang['inactive']."</span>";
                                            } else {
                                                echo "<span class='badge badge-soft-danger font-13'>".$datagetDepartmentById->department_status."</span>";
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2"><?= $lang["category_type"]; ?> :</td>
                                        <td><?= $lang[$datagetDepartmentById->department_type]; ?></td>
                                    </tr>

                                    <?php
                                    if (!empty($datagetDepartmentById->department_options)) {

                                        $temp = json_decode($datagetDepartmentById->department_options);
                                        $name = "";
            ...
            <input type="hidden" id="token" name="token" value="<?= Security::initCSRF('admin-department-edit') ?>">
            <script>
                var var_lang = '<?php
                    $var_lang = [
                        'error' => $lang['error'],
