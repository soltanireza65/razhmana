...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('add-cargo-in-js', '/dist/js/businessman/add-cargo-in.js');
    getHeader($lang['b_submit_cargo_in'], true);
    ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mj-b-stepper-card">
                            <img id="truck-addcargo" src="/dist/images/truck-image.png" alt="truck">
                                        ...
                                        <div class="mj-input-filter-box d-flex" style="padding: 4px 16px 4px 4px">
                                            ...
                                            <select class="mj-custom-form-select" id="cargo-monetary-unit"
                                                ...
                                                foreach ($currencies->response as $item) {
                                                    ?>
                                                    <option <?php
                                                     if($item->CurrencyId==1 && $language=='fa_IR'){
                                                         echo ' selected ';
                                                     }elseif ($item->CurrencyId==3 && $language=='tr_Tr'){
                                                         echo ' selected ';
                                                     }
                                                     ?>
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center">
                                        <input type="hidden" id="token" name="token"
                                               value="<?= Security::initCSRF('add-cargo-in') ?>">
                                        <button type="button"
                                                class="mj-btn-cancel btn-prev text-white border-0 w-100 me-1"
                                                style="min-height: 44px; border-radius: 10px;"><?= $lang['previous_level'] ?></button>
