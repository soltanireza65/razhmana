...
if (User::userIsLoggedIn()) {
    ...
    $requests = Businessman::getCargoInRequests($user->UserId, $_REQUEST['id'], $sort);
    ...
    if ($requests->status == 200) {
        ...
        enqueueScript('suggestions-in', '/dist/js/businessman/suggestions-in.js');
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive hidden-search">
                                    ...
                                    <input type="hidden" id="token" name="token"
                                           value="<?= Security::initCSRF('request-in-change') ?>">
                                </div>
                            </div>
                        </div>
