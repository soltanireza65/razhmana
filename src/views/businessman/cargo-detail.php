...
if (User::userIsLoggedIn()) {
    ...
    error_log("=============");
    error_log($cargo->status);
    error_log("=============");
    if ($cargo->status == 200) {
        $cargo = $cargo->response;
        $requests = Businessman::getCargoDrivers($user->UserId, $cargo->CargoId);
        ...
        enqueueScript('swiper-js', '/dist/libs/swiper/js/swiper-bundle.min.js');
        enqueueScript('cargo-detail-js', '/dist/js/businessman/cargo-detail.init.js');

        getHeader($lang['b_title_cargo_detail']);
            ...
            <div class="container" >
                ...
                if ($cargo->CargoStatus == 'pending') {
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <a href="/businessman/edit-cargo/<?= $cargo->CargoId ?>" class="mj-btn-more w-100"
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-center">
                                                <input type="hidden" id="token-cancel" name="token-cancel"
                                                       value="<?= Security::initCSRF('cancel-cargo') ?>">
                ...
                if (in_array($cargo->CargoStatus, ['accepted', 'progress'])) {
                        ...
                        foreach ($requests->response as $request) {
                            ...
                            <div class="col-12">
                                <div class="mj-info-box mj-b-info-box mb-3">
                                    ...
                                    <?php
                                    if (Complaint::checkCanSendComplaint($cargo->CargoId, $request->RequestId, $user->UserId, $request->UserId)) {
                                        ?>
                    ...
                    if (count($requests->response) < $cargo->CargoCarCount) {
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <a href="/businessman/suggestions/<?= $cargo->CargoId ?>" class="mj-btn-more w-100"
                                   style="min-height: 42px">
                    ...
                    <div class="col-12">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="position-relative">
                                                <img src="/dist/images/icons/house-signal.svg"
                                                     class="mj-b-cargo-item-icon <?= ($cargo->CargoGreen == "yes") ? "me-2" : ""; ?>"
                                                     alt="customs-of-origin"/>

                                                <?= ($cargo->CargoGreen == "yes") ? '<div class="mj-green-road-blob"></div>' : ""; ?>
                                            </div>
                                            <div>
                                                <div class="mj-b-cargo-item-title <?= ($cargo->CargoGreen == "yes") ? "" : "ps-2"; ?>"><?= $lang['b_cargo_source_customs'] ?></div>
                                                <div class="mj-b-cargo-item-value ps-2">
                                    ...
                                    <div class="cargo-detail col-6">
                                        <div class="d-flex align-items-center mb-3">
                                            <img src="/dist/images/icons/house-signal-1.svg"
                                                 class="mj-b-cargo-item-icon me-2" alt="destination-customs"/>
                                            <div>
                                                <div class="mj-b-cargo-item-title"><?= $lang['b_cargo_desc_customs'] ?></div>
                                                <div class="mj-b-cargo-item-value"><?= $cargo->CargoDestinationCustomsCity ?></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        if (!empty($requests->response)) {
                            ...
                            <input type="hidden" id="token-expenses" name="token-expenses"
                                   value="<?= Security::initCSRF('expenses') ?>">
                            <input type="hidden" id="token-rate" name="token-rate"
                                   value="<?= Security::initCSRF('rate') ?>">
