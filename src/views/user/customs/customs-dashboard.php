...
/*    if (!isset($_COOKIE['t-inquiry']) || $_COOKIE['t-inquiry'] != 'shown') {
        ...
        */?><!--
        ...
        --><?php
/*    }*/
    getHeader($lang['b_customs_services']);

    $sliders = $Settings['u_user_sliders_customs'];
    ?>
                        ...
                        <a href="/user/customs/inquiry-list/completed">
                            <div id="report-1" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Customs::getInquiryCountByStatus($user->UserId, 'completed') ?>
                                </span>
                        ...
                        <a href="/user/customs/inquiry-list/completed">
                            <div id="report-4" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Customs::getInquiryCountByStatus($user->UserId, 'read') ?>
                                </span>
                            ...
                            <div id="report-2" class="mj-b-report-card">
                                ...
                                <span>
                                   <?= $lang['u_process_inquiry'] ?>
                                    ...
                                    <span>
                                    <?= Customs::getInquiryCountByStatus($user->UserId, 'process') ?>
                                </span>
                        ...
                        <a href="/user/customs/inquiry-list/pending">
                            <div id="report-3" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Customs::getInquiryCountByStatus($user->UserId, 'pending') ?>
                                </span>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <video controls>
                            <source src="<?= $Settings['u_learning_customs']['link'] ?>" type="video/mp4">
                        </video>
                    </div>
            ...
            <div class="mj-b-video-card">
                <div class="mj-b-video-content">
                    <div class="mj-b-video-texts">
                        <h3><?= $Settings['u_learning_customs']['title'] ?></h3>
                    </div>
