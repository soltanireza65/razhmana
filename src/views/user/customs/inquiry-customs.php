...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('inquiry-init', '/dist/js/user/customs/inquiry-customs.init.js');

    getHeader($lang['u_inquiry_customs'], true);
    ?>
    <main style="padding-bottom: 0 !important; ">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="mj-b-stepper-card mj-cargo-custom-stepper">
                ...
                <div class="form-step ">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <label for="cargo-transportation-type"
                            ...
                            <div class="mj-custom-select  mj-a-transportation-type">
                                <select class="form-select"
                                        id="cargo-transportation-type"
                                        name="cargo-transportation-type"
                                        data-width="100%"
                                        data-placeholder="<?=$lang['u_select_transportations_please'];?>">
                                    <option value=""><?= $lang['b_select_ship_category'] ?></option>
                                    <?php
                                    foreach ($Transportations->response as $item) {
                                        ?>
                                        <option value="<?= $item->category_id ?>"><?= array_column(json_decode($item->category_name), 'value', 'slug')[$language] ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="mj-input-filter-box">
                                <input type="text"
                                       ...
                                       placeholder="<?=$lang['u_enter_customs_please'];?>"
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center">
                                <input type="hidden" id="token" name="token"
                                       value="<?= Security::initCSRF('inquiry-customs') ?>">
                                <button type="button"
                ...
                <div class="modal-content mj-modal-add-account mj-cargo-custom-modal">
                    ...
                    <div class="modal-body" style="padding: 10px 15px;">
                        ...
                        <div class="mj-add-account-form">
                            ...
                            <label for="commodity-code"><?=$lang['a_hscode_commodity'];?></label>
                            <input type="number"
                                   inputmode="numeric"
                                   id="commodity-code"
                                   name="commodity-code"
                                   class="mj-add-cargo-custom-input"
                                   placeholder="<?=$lang['u_enter_hscode_commodity'];?>">
