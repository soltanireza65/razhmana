...
if (User::userIsLoggedIn()) {
  ...
  /*  if (!isset($_COOKIE['t-inquiry']) || $_COOKIE['t-inquiry'] != 'shown') {
        ...
        */?><!--
        ...
        --><?php
/*    }*/
    getHeader($lang['b_dashboard_inventory']);

    $sliders = $Settings['u_user_sliders_inventory'];
    ?>
                        ...
                        <a href="/user/inventory/inquiry-list/completed">
                            <div id="report-1" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Inventory::getInquiryCountByStatus($user->UserId, 'completed') ?>
                                </span>
                        ...
                        <a href="/user/inventory/inquiry-list/completed">
                            <div id="report-4" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Inventory::getInquiryCountByStatus($user->UserId, 'read') ?>
                                </span>
                            ...
                            <div id="report-2" class="mj-b-report-card">
                                ...
                                <span>
                                   <?= $lang['u_process_inquiry'] ?>
                                    ...
                                    <span>
                                    <?= Inventory::getInquiryCountByStatus($user->UserId, 'process') ?>
                                </span>
                        ...
                        <a href="/user/inventory/inquiry-list/pending">
                            <div id="report-3" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Inventory::getInquiryCountByStatus($user->UserId, 'pending') ?>
                                </span>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <video controls>
                            <source src="<?= $Settings['u_learning_inventory']['link'] ?>" type="video/mp4">
                        </video>
                    </div>
            ...
            <div class="mj-b-video-card">
                <div class="mj-b-video-content">
                    <div class="mj-b-video-texts">
                        <h3><?= $Settings['u_learning_inventory']['title'] ?></h3>
                    </div>
