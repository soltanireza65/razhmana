...
/*    }*/
    ...
    getHeader($lang['b_dashboard_ship']);

    $sliders = $Settings['u_user_sliders_ship'];
    ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 col-lg-3 mj-b-reports-cols">
                        <a href="/user/ship/inquiry-list/completed">
                            <div id="report-1" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Ship::getInquiryCountByStatus($user->UserId, 'completed') ?>
                                </span>
                                    <img id="air-report" src="/dist/images/Ship-wheel.svg" alt="completed">
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-lg-3 mj-b-reports-cols">
                        <a href="/user/ship/inquiry-list/read">
                            <div id="report-4" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Ship::getInquiryCountByStatus($user->UserId, 'read') ?>
                                </span>
                    ...
                    <div class="col-6 col-lg-3 mj-b-reports-cols">
                        <a href="/user/ship/inquiry-list/process">
                            <div id="report-2" class="mj-b-report-card">
                                ...
                                <span>
                                   <?= $lang['u_process_inquiry'] ?>
                                    ...
                                    <span>
                                    <?= Ship::getInquiryCountByStatus($user->UserId, 'process') ?>
                                </span>
                                    <img src="/dist/images/ship-question.svg" alt="progress">
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-6 col-lg-3 mj-b-reports-cols">
                        <a href="/user/ship/inquiry-list/pending">
                            <div id="report-3" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Ship::getInquiryCountByStatus($user->UserId, 'pending') ?>
                                </span>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <video controls>
                            <source src="<?= $Settings['u_learning_ship']['link'] ?>" type="video/mp4">
                        </video>
                    </div>
            ...
            <div class="mj-b-video-card">
                <div class="mj-b-video-content">
                    <div class="mj-b-video-texts">
                        <h3><?= $Settings['u_learning_ship']['title'] ?></h3>
                    </div>
