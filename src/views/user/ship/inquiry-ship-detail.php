...
if (User::userIsLoggedIn()) {
    ...
    $freight = Ship::getInquiryDetail($_REQUEST['id'], $user->UserId);
    if ($freight->status == 200 && !empty($freight->response[0])) {
        ...
        $sourcePortOutput = '';
        if (!empty($freight->source_port_id) && !empty($freight->source_port_id)) {
            $sourcePortOutput = array_column(json_decode(Ship::getPortNameById($freight->source_port_id)), 'value', 'slug')[$langCookie];
        }

        $destPortOutput = '';
        if (!empty($freight->dest_port_id) && !empty($freight->dest_port_id)) {
            $destPortOutput = array_column(json_decode(Ship::getPortNameById($freight->dest_port_id)), 'value', 'slug')[$langCookie];
        }
        if($freight->freight_status == 'completed'){
            Ship::updateInquiryStatus($freight->freight_id, 'read');
        }
        ?>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                <div class="mj-d-cargo-item-category me-2"
                                    ...
                                    <img src="/dist/images/icons/ship/ship(white).svg"
                            ...
                            <div class="row">
                                ...
                                <div class="cargo-detail col-6">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="/dist/images/icons/ship/inport.svg"
                                             class="mj-d-cargo-item-icon me-2"
                                             alt="source port"/>
                                        <div>
                                            ...
                                            <div class="mj-d-cargo-item-value"><?= $sourcePortOutput ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cargo-detail col-6">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="/dist/images/icons/ship/outportsvg.svg"
                                             class="mj-d-cargo-item-icon me-2"
                                             alt="dest port"/>
                                        <div>
                                            ...
                                            <div class="mj-d-cargo-item-value"><?= $destPortOutput ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cargo-detail col-6">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="/dist/images/icons/ship/container.svg"
                                             class="mj-d-cargo-item-icon me-2"
                                             alt="container type"/>
                                        <div>
                                            ...
                                            <div class="mj-d-cargo-item-value"><?= array_column(json_decode($freight->container_name), 'value', 'slug')[$langCookie] ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cargo-detail col-6">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="/dist/images/icons/ship/container-count.svg"
                                             class="mj-d-cargo-item-icon me-2"
                                             alt="count container"/>
                                        <div>
                                            <div class="mj-d-cargo-item-title">
                                            ...
                                            <div class="mj-d-cargo-item-value">
                                                  <span>
                                                     <?= number_format(intval($freight->freight_count_container)); ?>
                                                  </span>
                                            </div>
                                        </div>
