...
if (User::userIsLoggedIn()) {
    ...
    getHeader($lang['u_injquiry_ship_list']);
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mj-card">
                    <div class="card-body">
                        <div class="mb-3">
                            <span class="mj-d-icon-title d-block mj-fw-700 mj-font-13 mb-1"><?= $lang['u_injquiry_ship_list'] ?></span>
                            <p class="mj-d-cargo-item-desc mb-0">
                                <span>
                                    <img src="/dist/images/icons/circle-exclamation-gray.svg" class="me-1"
                                         alt="exclamation"/>
                                </span>
                                <?= $lang['u_injquiry_ship_list_sub_title'] ?>
                            </p>
                        </div>
                            ...
                            <div class="col">
                                <div class="mj-input-filter-box">
                                    <input type="text" class="mj-input-filter" id="request-search" name="request-search"
                                           placeholder="<?= $lang['u_injquiry_ship_list_search_place_holder'] ?>">
                                            ...
                                            <div class="col-6">
                                                <a href="/user/ship/inquiry-list"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    ...
                                                    <span style="padding-right: 3px;"><?= $lang['u_inquiry_ship_all'] ?></span>
                                                </a>
                                            </div>
                        ...
                        <div class="table-responsive hidden-search">
                            <table id="requests-table"
                                ...
                                $records = Ship::getShipInquiryList($user->UserId, $status);
                                if (!empty($records->response)) {
                                    foreach ($records->response as $key => $item) {
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <a href="/user/ship/inquiry-detail/<?= $item->freight_id ?>"
                                                   class="mj-btn-more">
