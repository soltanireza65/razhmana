...
if (User::userIsLoggedIn()) {
    ...
    getHeader($lang['u_inquiry_minicargo_list']);
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mj-card">
                    <div class="card-body">
                        <div class="mb-3">
                            <span class="mj-d-icon-title d-block mj-fw-700 mj-font-13 mb-1"><?= $lang['u_inquiry_minicargo_list'] ?></span>
                            <p class="mj-d-cargo-item-desc mb-0">
                                <span>
                                    <img src="/dist/images/icons/circle-exclamation-gray.svg" class="me-1"
                                         alt="exclamation"/>
                                </span>
                                <?= $lang['u_inquiry_minicargo_list_sub_title'] ?>
                            </p>
                        </div>
                            ...
                            <div class="col">
                                <div class="mj-input-filter-box">
                                    <input type="text" class="mj-input-filter" id="request-search" name="request-search"
                                           placeholder="<?= $lang['u_inquiry_minicargo_list_search_place_holder'] ?>">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu mj-dropdown-menu">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="/user/minicargo/inquiry-list"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                                                    ...
                                                    <span style="padding-right: 3px;"><?= $lang['u_inquiry_minicargo_all'] ?></span>
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                <a href="/user/minicargo/inquiry-list/read"
                                                   class="d-flex align-items-center mj-btn-filter-link mb-2">
                        ...
                        <div class="table-responsive hidden-search">
                            <table id="requests-table"
                                ...
                                <tr>
                                    <th>#</th>
                                    <th><?= $lang['u_inquery_minicargo_table_title'] ?></th>
                                ...
                                $records = MiniCargo::inquiryMiniCargoList($user->UserId, $status);
                                if (!empty($records->response)) {
                                    ...
                                    foreach ($records->response as $key => $item) {
                                        ...
                                        <tr class="align-middle">
                                            <td><?= $counter ?></td>
                                            <td><?=$lang['u_inquery_minicargo_name_prefix']?> <?= $item->freight_id ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="/user/minicargo/inquiry-detail/<?= $item->freight_id ?>"
                                                   class="mj-btn-more">
