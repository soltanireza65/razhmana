...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('inquiry-init', '/dist/js/businessman/inquiry-air.init.js');

    getHeader($lang['b_inquiry_air'], true);
    $airCategories = Air::getAllAirCategoryByStatus();
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mj-b-stepper-card">
                        <img src="/dist/images/plane-inquirypng.png" alt="">
                ...
                <div class="col-12">
                    <div class="form-step form-step-active">
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mj-custom-select cargo-type">
                                        <select class="form-select my-1 mb-3" id="cargo-type" name="cargo-type"
                                                data-width="100%">
                                            <option value="-1"
                                                    selected><?= $lang['b_select_ship_category'] ?></option>
                                            <?php

                                            foreach ($airCategories->response as $item) {
                                                ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mj-custom-select cargo-packing-type">
                                        <select class="form-select my-1 mb-3" id="cargo-packing-type"
                                                name="cargo-packing-type"
                                                data-width="100%">
                                            <option value="-1"
                                                    selected><?= $lang['b_packing_type_select'] ?></option>
                                            <?php
                                            $airPackings = Air::getAllPackingByStatus();
                                            foreach ($airPackings->response as $item) {
                                                ?>
                            ...
                            <div class="col-6 d-flex" dir="ltr">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="cargo-discharge"
                                               style="width: 3rem">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mj-input-filter-box d-flex" style="padding: 4px 16px 4px 4px">
                                        <input type="text" inputmode="numeric"
                                               ...
                                               placeholder="<?= $lang['u_inquiry_recommended_price'] ?>"
                                               style="min-height: 38px;">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    <input type="hidden" id="token" name="token"
                                           value="<?= Security::initCSRF('inquiry-air') ?>">
                                    <button type="button"
                                            class="mj-btn-cancel btn-prev text-white border-0 w-100 me-1"
                                            style="min-height: 44px; border-radius: 10px;"><?= $lang['previous_level'] ?></button>
