...
//    }
    ...
    getHeader($lang['b_dashboard_rail']);

    $sliders = $Settings['u_user_sliders_railroad'];
    ?>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-6 mj-b-dashboard-btns">
                        <div class="mj-b-add-cargo" id="t-list">
                            <a href="/user/railroad/inquiry-list">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 col-lg-3 mj-b-reports-cols">
                        <a href="/user/railroad/inquiry-list/completed">
                            <div id="report-1" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Railroad::getInquiryCountByStatus($user->UserId, 'completed') ?>
                                </span>
                                    <img id="train-report" src="/dist/images/trian-inquiry.svg" alt="completed">
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="/user/railroad/inquiry-list/completed">
                            <div id="report-4" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Railroad::getInquiryCountByStatus($user->UserId, 'read') ?>
                                </span>
                                    <img id="ceck-report" src="/dist/images/check.svg" alt="completed">
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-6 col-lg-3 mj-b-reports-cols">
                        <a href="/user/railroad/inquiry-list/process">
                            <div id="report-2" class="mj-b-report-card">
                                ...
                                <span>
                                   <?= $lang['u_process_inquiry'] ?>
                                    ...
                                    <span>
                                    <?= Railroad::getInquiryCountByStatus($user->UserId, 'process') ?>
                                </span>
                                    <img id="train-question" src="/dist/images/train-question.svg" alt="progress">
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-6 col-lg-3 mj-b-reports-cols">
                        <a href="/user/railroad/inquiry-list/pending">
                            <div id="report-3" class="mj-b-report-card">
                                ...
                                <span>
                                    ...
                                    <span>
                                    <?= Railroad::getInquiryCountByStatus($user->UserId, 'pending') ?>
                                </span>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <video controls>
                            <source src="<?= $Settings['u_learning_railroad']['link'] ?>" type="video/mp4">
                        </video>
                    </div>
            ...
            <div class="mj-b-video-card">
                <div class="mj-b-video-content">
                    <div class="mj-b-video-texts">
                        <h3><?= $Settings['u_learning_railroad']['title'] ?></h3>
                    </div>
