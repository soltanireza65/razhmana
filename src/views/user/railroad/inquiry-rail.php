...
if (User::userIsLoggedIn()) {
    ...
    enqueueScript('inquiry-init', '/dist/js/businessman/inquiry-rail.init.js');

    getHeader($lang['b_inquiry_rail'], true);
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mj-b-stepper-card">
                        <img id="train" src="/dist/images/railroad-inquiry.png" alt="railroad inquiry">
                ...
                <div class="col-12">
                    <div class="form-step form-step-active">
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mj-custom-select cargo-type">
                                        <select class="form-select my-1 mb-3" id="cargo-type" name="cargo-type"
                                            ...
                                            <?php
                                            $cargoTypes = Railroad::getAllCargoCategory();
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="cargo-wagon-type"
                                           class="text-dark mj-fw-500 mj-font-12 mb-1">
                                        <?= $lang['b_wagon_type'] ?>
                                    </label>
                                    <div class="mj-custom-select cargo-wagon-type">
                                        <select class="form-select my-1 mb-3" id="cargo-wagon-type"
                                                name="cargo-car-type"
                                                data-width="100%">
                                            <option value="-1" selected><?= $lang['b_select_wagon_type'] ?></option>
                                            <?php
                                            $wagonType = Railroad::getWagonType();
                                            foreach ($wagonType->response as $item) {
                                                ?>
                                                <option value="<?= $item->wagon_id ?>"><?= $item->wagon_name ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="cargo-container-type"
                                           class="text-dark mj-fw-500 mj-font-12 mb-1">
                                        <?= $lang['b_container_type'] ?>
                                    </label>
                                    <div class="mj-custom-select cargo-container-type">
                                        <select class="form-select my-1 mb-3" id="cargo-container-type"
                                                name="cargo-car-type"
                                                data-width="100%">
                                            <option value="-1" selected><?= $lang['b_select_container_type'] ?></option>
                                            <?php
                                            $containerType = Railroad::getContainerType();
                                            foreach ($containerType->response as $item) {
                                                ?>
                                                <option value="<?= $item->container_id ?>"><?= $item->container_name ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="mj-custom-select cargo-packing-type">
                                        <select class="form-select my-1 mb-3" id="cargo-packing-type"
                                                name="cargo-car-type"
                                                data-width="100%">
                                            <option value="-1" selected><?= $lang['b_select_packing_type'] ?></option>
                                            <?php
                                            $packingType = Railroad::getPackingType();
                                            foreach ($packingType->response as $item) {
                                                ?>
                                                <option value="<?= $item->packing_id ?>"><?= $item->packing_name ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    <input type="hidden" id="token" name="token"
                                           value="<?= Security::initCSRF('inquiry-railroad') ?>">
                                    <button type="button"
                                            class="mj-btn-cancel btn-prev text-white border-0 w-100 me-1"
                                            style="min-height: 44px; border-radius: 10px;"><?= $lang['previous_level'] ?></button>
