...
$auth_users = array(
    'ntirapp_admin_85' => '$2y$10$ik1uJPnZ3tKKeZCRBoroPOm9nCcqvDgdqk7E5pml2.o0kIml9jXq2', //ntir@15987+
...
// highlight.js style
// for dark theme use 'ir-black' or 'vs
...
$root_path = $_SERVER['DOCUMENT_ROOT'] . '/uploads/medias';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/uploads/medias';
...
$favicon_path = '/uploads/site/favicon.webp';
                    ...
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            ...
                            <a href="/" target="_blank"
                               class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">CCP
        ...
        <div class="card <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <p class="break-word">
                        <strong><?php echo lng('SourceFolder') ?></strong>: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?>
                        <br>
    ...
    <div class="col-md-8 offset-md-2 pt-3">
        <div class="card mb-2 <?php echo fm_get_theme(); ?>">
            <h6 class="card-header d-flex justify-content-between">
                ...
                <a href="?p=<?php echo FM_PATH ?>" class="text-danger"><i
                            class="fa fa-times-circle-o"></i> <?php echo lng('Cancel') ?></a>
            </h6>
            <div class="card-body">
                <form id="js-settings-form" action="" method="post" data-type="ajax"
                    ...
                    <div class="form-group row">
                        <label for="js-language"
                               class="col-sm-3 col-form-label"><?php echo lng('Language') ?></label>
                        <div class="col-sm-5">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="js-show-hidden"
                                       name="js-show-hidden"
                                       value="true" <?php echo $show_hidden_files ? 'checked' : ''; ?> />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label for="js-hide-cols"
                               class="col-sm-3 col-form-label"><?php echo lng('HideColumns') ?></label>
                        <div class="col-sm-9">
                            <div class="form-check form-switch">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank"
                               class="app-v-title"> File Manager <?php echo VERSION; ?></a></h3></p>
                    ...
                    <div class="col-12">
                        <form class="form-inline" onsubmit="return new_password_hash(this)" method="POST" action="">
                            ...
                            <div class="form-group mx-sm-3 mb-2">
                                ...
                                <input type="text" class="form-control btn-sm" id="inputPassword2"
                                       name="inputPassword2" placeholder="<?php echo lng('Password') ?>" required>
                            </div>
                            <button type="submit"
...
if (isset($_GET['view'])) {
    ...
    <div class="row">
        <div class="col-12">
            <p class="break-word"><b><?php echo lng($view_title) ?> "<?php echo fm_enc(fm_convert_win($file)) ?>
                    "</b></p>
            <p class="break-word">
                <strong>Full path:</strong> <?php echo fm_enc(fm_convert_win($file_path)) ?><br>
                <strong>File
                    size:</strong> <?php echo ($filesize_raw <= 1000) ? "$filesize_raw bytes" : $filesize; ?><br>
                ...
                if (($is_zip || $is_gzip) && $filenames !== false) {
                    ...
                    <?php echo lng('Compression') ?>: <?php echo round(($total_comp / max($total_uncomp, 1)) * 100) ?>%
                    <br>
                    <?php
                }
                // Image info
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                if (!FM_READONLY && ($is_zip || $is_gzip) && $filenames !== false) {
                    ...
                    <form method="post" class="d-inline ms-2">
                        ...
                        <button type="submit" class="btn btn-link text-decoration-none fw-bold p-0"
                                style="font-size: 14px;" title="UnZip to <?php echo fm_enc($zip_name) ?>"><i
                                    class="fa fa-check-circle"></i> <?php echo lng('UnZipToFolder') ?></button>
                    </form>&nbsp;
                    <?php
                }
    ...
    <div class="path">
        <div class="row">
                ...
                <div class="btn-toolbar" role="toolbar">
                    <?php if (!$isNormalEditor) { ?>
                        <div class="btn-group js-ace-toolbar">
                            <button data-cmd="none" data-option="fullscreen"
                                    class="btn btn-sm btn-outline-secondary" id="js-ace-fullscreen"
                                    title="<?php echo lng('Fullscreen') ?>"><i class="fa fa-expand"
                            ...
                            <select id="js-ace-fontSize" data-type="fontSize"
                                    title="<?php echo lng('Select Font Size') ?>"
                                    class="btn-outline-secondary border-start-0 d-none d-lg-block">
            ...
            <div class="edit-file-actions col-xs-12 col-sm-7 col-lg-6 text-end pt-1">
                ...
                <a title="<?php echo lng('BackUp') ?>" class="btn btn-sm btn-outline-primary"
            ...
            <?php if (!FM_READONLY): ?>
                <div class="col-xs-12 col-sm-9">
                    <ul class="list-inline footer-action">
                        ...
                        <li class="list-inline-item"><input type="submit" class="hidden" name="zip" id="a-zip"
                                                            value="zip"
                        ...
                        <li class="list-inline-item"><input type="submit" class="hidden" name="tar" id="a-tar"
                                                            value="tar"
                                                            onclick="return confirm('<?php echo lng('Create archive?'); ?>')">
                ...
                <div class="col-3 d-none d-sm-block"><a href="/" target="_blank"
                                                        class="float-right text-muted">File
                        Manager <?php echo VERSION; ?></a></div>
            <?php else: ?>
                <div class="col-12"><a href="/" target="_blank"
                                       class="float-right text-muted">File Manager <?php echo VERSION; ?></a></div>
            <?php endif; ?>
        </div>
    </form>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = "<a href='/media.php?p='><i class='fa fa-home' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
                ...
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme(); ?>">
                    <li class="nav-item mr-2">
                        <div class="input-group input-group-sm mr-1" style="margin-top:4px;">
                            <input type="text" class="form-control" placeholder="<?php echo lng('Filter') ?>"
                    ...
                    <?php if (!FM_READONLY): ?>
                        ...
                        <li class="nav-item">
                            <a title="<?php echo lng('NewItem') ?>" class="nav-link" href="#createNewItem"
                               data-bs-toggle="modal" data-bs-target="#createNewItem"><i
                            ...
                            <div class="dropdown-menu text-small shadow <?php echo fm_get_theme(); ?>"
                                ...
                                <?php if (!FM_READONLY): ?>
                                    <a title="<?php echo lng('Settings') ?>" class="dropdown-item nav-link"
                                       href="?p=<?php echo urlencode(FM_PATH) ?>&amp;settings=1"><i
                                                class="fa fa-cog"
...
function fm_show_header_login()
{
    ...
    <head>
        ...
        <meta name="description"
              content="Web based File Manager in PHP, Manage your files efficiently and easily with File Manager">
...
function fm_show_header()
{
    ...
    <head>
        ...
        <?php if (FM_USE_HIGHLIGHTJS && isset($_GET['view'])): ?>
            <link rel="stylesheet"
                  href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/styles/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
        <?php endif; ?>
        ...
        if (FM_THEME == "dark"): ?>
            <style>
                ...
                a, a:hover, a:visited, a:active, #main-table .filename a, i.fa.fa-folder-o, i.go-back {
                    color: var(--bg-color);
                }
                ...
                .theme-dark .table-bordered td .custom-control-input, .theme-dark .table-bordered th .custom-control-input {
                    opacity: 0.678;
                }
    ...
    <div id="wrapper" class="container-fluid">
                ...
                <form class="modal-content rounded-3 shadow <?php echo fm_get_theme(); ?>" method="post"
                    ...
                    <div class="modal-footer flex-nowrap p-0">
                        ...
                        <button type="submit" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0">
                            <strong><?php echo lng('Okay') ?></strong></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <script type="text/html" id="js-tpl-confirm">
            <div class="modal modal-alert confirmDailog" data-bs-backdrop="static" data-bs-keyboard="false"
                 tabindex="-1" role="dialog" id="confirmDailog-<%this.id%>">
                <div class="modal-dialog" role="document">
                    <form class="modal-content rounded-3 shadow <?php echo fm_get_theme(); ?>" method="post"
